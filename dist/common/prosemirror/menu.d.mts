 ...
 *   ProseMirrorMenuItem, ProseMirrorMenuOptions, ProseMirrorMenuResizeState} from "./_types.mjs"
 */
/**
...
export default class ProseMirrorMenu extends ProseMirrorPlugin {
     ...
     * @param {Document} document  The document to bind to.
     */
     ...
     */
    constructor(schema: Plugin, view: Plugin, options?: ProseMirrorMenuOptions | undefined);
    /**
     ...
     * @protected
     */
    protected _onResize([entry]: ResizeObserverEntry[]): void;
    /**
     ...
     * @param {MarkType} markType  The mark to remove.
     * @protected
     */
     ...
     * @param {Function} dispatch  Dispatch changes to the editor state.
     * @param {EditorView} view    The editor view.
     * @param {string} html        The insert's markup.
     * @param {object} [options]
     * @param {boolean} [options.inline]  Whether the insert contains inline content, otherwise block content is assumed.
     * @protected
     */
    protected _placeInsert(state: EditorState, dispatch: Function, view: Plugin, html: string, { inline }?: {
     ...
     * @param {MarkType} markType  The mark to apply.
     * @param {Attrs|null} attrs   The mark's attributes.
     * @protected
     */
     ...
     * @protected
     */
    protected getActionElement(action: string): HTMLElement;
    #private;
}
