...
export namespace track {
    ...
    export function toDOM_9(): string[];
...
export namespace source {
    ...
    export function toDOM_10(): string[];
...
export namespace figure {
    ...
    export function toDOM_12(): (string | number)[];
...
export namespace figcaption {
    ...
    export function toDOM_13(): (string | number)[];
...
export namespace iframe {
    ...
    export function toDOM_18(node: any): (string | {
        sandbox: any;
    })[];
