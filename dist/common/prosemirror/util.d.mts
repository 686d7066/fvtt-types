 ...
 */
export function parseHTMLString(htmlString: string, schema?: any): Node;
/**
 * Use the StringSerializer to convert a ProseMirror document into an HTML string. This can be used server-side.
 * @param {Fragment} doc                    The ProseMirror document.
 ...
 * @returns {string}
 */
export function serializeHTMLString(doc: Fragment, { schema, spaces }?: {
    schema?: any;
