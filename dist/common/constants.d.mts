...
/**
 * @typedef {typeof ACTIVE_EFFECT_DURATION_UNITS[number]} ActiveEffectDurationUnit
 */
/**
 ...
 */
export const PRIMARY_DOCUMENT_TYPES: readonly ["ActiveEffect", "Actor", "Adventure", "Cards", "ChatMessage", "Combat", "FogExploration", "Folder", "Item", "JournalEntry", "Macro", "Playlist", "RollTable", "Scene", "Setting", "User"];
/**
 * The embedded Document types.
 */
export const EMBEDDED_DOCUMENT_TYPES: readonly ["ActiveEffect", "ActorDelta", "AmbientLight", "AmbientSound", "Card", "Combatant", "CombatantGroup", "Drawing", "Item", "JournalEntryCategory", "JournalEntryPage", "Note", "PlaylistSound", "Region", "RegionBehavior", "Level", "TableResult", "Tile", "Token", "Wall"];
/**
 ...
 *   "JournalEntry", "JournalEntryCategory", "JournalEntryPage", "Macro", "Note", "Playlist",
 *   "PlaylistSound", "Region", "RegionBehavior", "RollTable", "Scene", "Level", "Setting", "TableResult", "Tile",
 *   "Token", "User", "Wall"]}
 */
export const ALL_DOCUMENT_TYPES: readonly ["ActiveEffect", "Actor", "ActorDelta", "Adventure", "AmbientLight", "AmbientSound", "Card", "Cards", "ChatMessage", "Combat", "Combatant", "CombatantGroup", "Drawing", "FogExploration", "Folder", "Item", "JournalEntry", "JournalEntryCategory", "JournalEntryPage", "Macro", "Note", "Playlist", "PlaylistSound", "Region", "RegionBehavior", "RollTable", "Scene", "Level", "Setting", "TableResult", "Tile", "Token", "User", "Wall"];
/**
 ...
 */
export const COMPENDIUM_DOCUMENT_TYPES: readonly ["ActiveEffect", "Actor", "Adventure", "Cards", "Item", "JournalEntry", "Macro", "Playlist", "RollTable", "Scene"];
/**
 ...
 */
export const FOLDER_DOCUMENT_TYPES: readonly ["ActiveEffect", "Actor", "Adventure", "Item", "Scene", "JournalEntry", "Playlist", "RollTable", "Cards", "Macro", "Compendium"];
/**
...
export const PACKAGE_AVAILABILITY_CODES: Readonly<{
     ...
     */
    readonly REQUIRES_CORE_UPGRADE_UNKNOWN: 10;
    /**
     * A required dependency is not compatible with the current version of Foundry
     */
    readonly REQUIRES_DEPENDENCY_UPDATE: 11;
}>;
/**
...
export const USER_PERMISSIONS: Readonly<{
    readonly ACTOR_CREATE: {
        ...
        readonly requiredRoles: readonly [3, 4];
    ...
    readonly BROADCAST_AUDIO: {
        ...
        readonly requiredRoles: readonly [];
    ...
    readonly FILES_UPLOAD: {
        ...
        readonly requiredRoles: readonly [4];
        readonly defaultRole: 3;
    };
    ...
    readonly REGION_CREATE: {
        readonly label: "PERMISSION.RegionCreate";
        readonly hint: "PERMISSION.RegionCreateHint";
        readonly requiredRoles: readonly [3, 4];
        readonly defaultRole: 1;
    };
...
/**
 * @typedef {typeof EDGE_RESTRICTION_TYPES[number]} EdgeRestrictionType
 */
/**
...
/**
 * @typedef {typeof EDGE_SENSE_TYPES[keyof typeof EDGE_SENSE_TYPES]} EdgeSenseType
 */
/**
...
/**
 * @typedef {typeof EDGE_DIRECTIONS[keyof typeof EDGE_DIRECTIONS]} EdgeDirection
 */
/**
...
/**
 * @typedef {typeof EDGE_DIRECTION_MODES[keyof typeof EDGE_DIRECTION_MODES]} EdgeDirectionMode
 */
/**
 ...
 */
export const TEXTURE_FILE_EXTENSIONS: Readonly<{
    readonly basis: "application/octet-stream";
...
export namespace FILE_CATEGORIES {
    ...
    export { TEXTURE_FILE_EXTENSIONS as TEXTURE };
    export { GRAPHICS_FILE_EXTENSIONS as GRAPHICS };
    export const MEDIA: ("image/apng" | "image/avif" | "image/bmp" | "image/gif" | "image/jpeg" | "image/png" | "image/svg+xml" | "image/tiff" | "image/webp" | "video/mp4" | "video/ogg" | "video/webm" | "application/octet-stream" | "audio/aac" | "audio/flac" | "audio/mp4" | "audio/midi" | "audio/mpeg" | "audio/ogg" | "audio/opus" | "audio/wav" | "audio/webm" | "text/csv" | "application/json" | "text/markdown" | "application/pdf" | "text/tab-separated-values" | "text/plain" | "application/xml" | "application/yaml" | "font/otf" | "font/ttf" | "font/woff" | "font/woff2" | "model/gltf-binary" | "model/gltf+json" | "model/mtl" | "model/obj" | "model/stl" | "model/vnd.usdz+zip")[];
}
/**
 ...
 */
export const MEDIA_MIME_TYPES: ("image/apng" | "image/avif" | "image/bmp" | "image/gif" | "image/jpeg" | "image/png" | "image/svg+xml" | "image/tiff" | "image/webp" | "video/mp4" | "video/ogg" | "video/webm" | "application/octet-stream" | "audio/aac" | "audio/flac" | "audio/mp4" | "audio/midi" | "audio/mpeg" | "audio/ogg" | "audio/opus" | "audio/wav" | "audio/webm" | "text/csv" | "application/json" | "text/markdown" | "application/pdf" | "text/tab-separated-values" | "text/plain" | "application/xml" | "application/yaml" | "font/otf" | "font/ttf" | "font/woff" | "font/woff2" | "model/gltf-binary" | "model/gltf+json" | "model/mtl" | "model/obj" | "model/stl" | "model/vnd.usdz+zip")[];
/**
...
export const ALLOWED_HTML_ATTRIBUTES: Readonly<{
    ...
    readonly "formula-input": readonly ["disabled", "name", "value", "placeholder", "readonly", "required", "context"];
...
export const SETUP_PACKAGE_PROGRESS: Readonly<{
    readonly ACTIONS: {
        ...
        readonly CREATE_WORLD: "createWorld";
    ...
    readonly STEPS: {
        ...
        readonly IMPORT_ADVENTURE: "importAdventure";
    };
}>;
/**
...
export namespace REGION_EVENTS {
    ...
    let REGION_ANIMATION: "regionAnimation";
 ...
 */
export const IDLE_THRESHOLD_MS: number;
/**
