 ...
 * @property {string} [tempDir]                 A custom path where downloaded package archives are temporarily stored
 *                                              during extraction.
...
export class ServerSettings extends DataModel<object, foundry.abstract.types.DataModelConstructionContext> {
     ...
     * @param {string} port     The requested port number
     * @throws                  An error if the port number is invalid
     */
    static "__#267@#validatePort"(port: string): void;
    /**
     * Validate a path to a Unix domain socket.
     * @param {string} path     The requested path
     * @throws                  An error if the port number is invalid
     */
    static "__#267@#validateUDS"(path: string): void;
    constructor(data?: object | undefined, { parent, schema, strict, ...options }?: foundry.abstract.types.DataModelConstructionContext | undefined);
}
