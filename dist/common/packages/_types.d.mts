...
/**
 * See {@link foundry.utils.isNewerVersion} for the function used for comparison.
 */
...
export type PackageManifestData = {
     ...
     * See {@link foundry.utils.isNewerVersion}.
     */
    version: string;
    /**
...
export type ServerSanitizationFields = {
     ...
     * Each key is a field path and the values are an array of keys in {@link CONST.FILE_CATEGORIES}.
     */
...
export type _ModuleManifestData = {
     ...
     */
    quickstart?: QuickstartManifestData | undefined;
};
export type QuickstartManifestData = {
    /**
...
export type QuickstartAdventureData = {
    /**
