...
export default class BaseFogExploration extends Document<FogExplorationData, foundry.abstract.types.DocumentConstructionContext> {
    ...
    static "__#71@#canModify"(user: foundry.documents.BaseUser, document: Document, data?: object | undefined): boolean;
    constructor(data?: Partial<FogExplorationData> | undefined, { parent, schema, strict, ...options }?: foundry.abstract.types.DocumentConstructionContext | undefined);
    /** @inheritDoc */
