...
export default class BaseUser extends Document<UserData, foundry.abstract.types.DocumentConstructionContext> {
     ...
     * @returns {boolean}
     */
    static "__#242@#validateHotbar"(bar: object): boolean;
    /**
     * Validate the structure of the User permissions object
     * @param {object} perms      The attempted permissions data
     * @returns {boolean}
     */
    static "__#242@#validatePermissions"(perms: object): boolean;
    static "__#242@#canCreate"(user: BaseUser, document: Document, data?: object | undefined): boolean;
    static "__#242@#canUpdate"(user: BaseUser, document: Document, data?: object | undefined): boolean;
    static "__#242@#canDelete"(user: BaseUser, document: Document, data?: object | undefined): boolean;
    constructor(data?: Partial<UserData> | undefined, { parent, schema, strict, ...options }?: foundry.abstract.types.DocumentConstructionContext | undefined);
    /**
     ...
     */
    hasRole(role: string | number, { exact }?: boolean | undefined): boolean;
}
