...
export default class BaseTableResult extends Document<TableResultData, foundry.abstract.types.DocumentConstructionContext> {
    ...
    static "__#77@#canUpdate"(user: foundry.documents.BaseUser, document: Document, data?: object | undefined): boolean;
    /** @inheritDoc */
     ...
     */
    static "__#77@#migrateDocumentUuid"(data: object): void;
    /** @inheritDoc */
     ...
     * @param {object} data
     */
    static "__#77@#shimDocumentUuid"(data: object): void;
    constructor(data?: Partial<TableResultData> | undefined, { parent, schema, strict, ...options }?: foundry.abstract.types.DocumentConstructionContext | undefined);
    /**
     * @deprecated since V13
     * @ignore
     */
