...
export default class BaseCombatant extends Document<CombatantData, foundry.abstract.types.DocumentConstructionContext> {
    ...
    static "__#69@#canUpdate"(user: foundry.documents.BaseUser, document: Document, data?: object | undefined): boolean;
    constructor(data?: Partial<CombatantData> | undefined, { parent, schema, strict, ...options }?: foundry.abstract.types.DocumentConstructionContext | undefined);
    /** @inheritDoc */
