...
export default class BaseMacro extends Document<MacroData, foundry.abstract.types.DocumentConstructionContext> {
    ...
    static "__#73@#canCreate"(user: foundry.documents.BaseUser, document: Document, data?: object | undefined): boolean;
    static "__#73@#canUpdate"(user: foundry.documents.BaseUser, document: Document, data?: object | undefined): boolean;
    constructor(data?: Partial<MacroData> | undefined, { parent, schema, strict, ...options }?: foundry.abstract.types.DocumentConstructionContext | undefined);
    /** @inheritDoc */
