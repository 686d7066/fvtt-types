...
export type EffectDurationData = {
     ...
     */
    units: ActiveEffectDurationUnit;
    /**
...
export type TokenData = {
     ...
     */
    detectionModes: {
        [id: string]: TokenDetectionMode<true>;
    };
    /**
...
export type TokenCoordinates = Pick<TokenPosition, "x" | "y" | "elevation" | "level">;
export type TokenDimensions = Pick<TokenPosition, "width" | "height" | "depth" | "shape">;
/**
...
export type LevelData = {
    ...
    background: LevelTexture & {
        color: number;
    };
    foreground: LevelTexture;
    fog: Omit<LevelTexture, "alphaThreshold">;
    textures: Omit<TextureData, "src" | "tint" | "alphaThreshold">;
    visibility: {
        levels: Set<string>;
    };
    sort: number;
...
import type { ActiveEffectDurationUnit } from "../constants.mjs";
