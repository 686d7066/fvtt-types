...
export default class BaseCombat extends Document<CombatData, foundry.abstract.types.DocumentConstructionContext> {
    ...
    static "__#68@#canUpdate"(user: foundry.documents.BaseUser, document: Document, data?: object | undefined): boolean;
    constructor(data?: Partial<CombatData> | undefined, { parent, schema, strict, ...options }?: foundry.abstract.types.DocumentConstructionContext | undefined);
    /**
