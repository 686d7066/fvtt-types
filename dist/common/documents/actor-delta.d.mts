 ...
 * @import {DataModelUpdateOptions} from "../abstract/_types.mjs";
 */
/**
...
export default class BaseActorDelta extends Document<ActorDeltaData, foundry.abstract.types.DocumentConstructionContext> {
     ...
     */
    static applyDelta(delta: ActorDelta, baseActor: BaseActor, context?: object | undefined): BaseActor | null;
    /**
     ...
     */
    static "__#65@#mergeEmbeddedCollections"(documentClass: typeof Document, baseData: object, deltaData: object): void;
    /**
     ...
     * @returns {object[]}
     */
    static "__#65@#mergeEmbeddedCollection"(base?: object[], delta?: object[]): object[];
    /** @override */
    static override migrateData(source: any): object;
    constructor(data?: Partial<ActorDeltaData> | undefined, { parent, schema, strict, ...options }?: foundry.abstract.types.DocumentConstructionContext | undefined);
    /** @override */
