...
} | undefined): LineIntersection | null;
/**
 ...
 * @returns {LineIntersection|null}   An intersection point, or null if no intersection occurred
 */
export function lineSegmentIntersection(a: Point, b: Point, c: Point, d: Point, epsilon?: number | undefined): LineIntersection | null;
/**
 ...
 * @param {Point} c                    The reference point C
 * @param {Point[]|number[]} points    The points of the path P, which must not be empty
 * @param {boolean} close              If true, the edge from the last to the first point of the path is tested
 * @returns {Point}                    The closest point to C on the path P
 * @see {@link https://en.wikipedia.org/wiki/Distance_from_a_point_to_a_line#Line_defined_by_two_points}
 */
export function closestPointToPath(c: Point, points: Point[] | number[], close: boolean): Point;
/**
 ...
 */
export function quadraticIntersection(p0: Point, p1: Point, center: Point, radius: number, epsilon?: number | undefined): LineIntersection[];
/**
