 ...
 */
export default function EventEmitterMixin<TBaseClass extends Function>(BaseClass?: TBaseClass | undefined): {
    new (): {
        /**
         * A mapping of registered events.
         * @type {Record<string, Map<EmittedEventListener, {fn: EmittedEventListener, once: boolean}>>}
         */
        "__#232@#events": Record<string, Map<EmittedEventListener, {
