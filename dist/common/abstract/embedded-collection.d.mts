...
export default class EmbeddedCollection<TDocument extends Document> extends Collection<string, TDocument> {
     ...
     */
    initialize(options?: DocumentConstructionContext | undefined): void;
    /**
     ...
     * @protected
     */
    protected _initializeDocument(data: object, options?: DocumentConstructionContext | undefined): TDocument | null;
    /**
     ...
     * @returns {TDocument}
     */
    createDocument(data: object, context?: DocumentConstructionContext | undefined): TDocument;
    /**
     * Log warnings or errors when a Document is found to be invalid.
     * @param {object} data                    The invalid Document's data.
     ...
     * @protected
     */
    protected _handleInvalidDocument(data: object, err: Error, { strict }?: {
     ...
     * @protected
     */
    protected _delete(key: string, options?: object | undefined): void;
    /**
     ...
     * @returns {boolean}     Is the specified document managed by this collection?
     */
