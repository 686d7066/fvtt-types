...
export default class Document<DocumentData extends object = object, DocumentContext extends DocumentConstructionContext = DocumentConstructionContext> extends DataModel<DocumentData, DocumentContext> {
    ...
    /** @inheritDoc */
    static _preCleanData(data: any, options: any, _state: any): void;
    /**
     ...
     * ```
     */
    static createDocuments(data?: Array<object | Document>, operation?: Partial<Omit<DatabaseCreateOperation, "data">> | undefined): Promise<Document[]>;
    /**
     ...
     * ```
     */
    static updateDocuments(updates?: object[], operation?: Partial<Omit<DatabaseUpdateOperation, "updates">> | undefined): Promise<Document[]>;
    /**
     ...
     * @throws {Error}                    If an invalid operation is attempted.
     *
     ...
     * ```
     */
    static deleteDocuments(ids?: string[], operation?: Partial<Omit<DatabaseDeleteOperation, "ids">> | undefined): Promise<Document[]>;
    /**
     ...
     * ```
     */
    static create(data?: object | Document<object, DocumentConstructionContext> | (object | Document<object, DocumentConstructionContext>)[] | undefined, operation?: Partial<Omit<DatabaseCreateOperation, "data">> | undefined): Promise<Document | Document[] | undefined>;
    /**
     ...
     */
    static get(documentId: string, operation?: DatabaseGetOperation | undefined): Document | null;
    /**
     ...
     * @internal
     */
    static _addDataFieldMigration(data: object, oldKey: string, newKey: string, apply?: ((data: object) => any) | undefined): boolean;
    /**
     ...
     * @internal
     */
    static _logDataFieldMigration(oldKey: string, newKey: string, options?: object | undefined): void;
    /**
    ...
    constructor(data?: Partial<DocumentData> | undefined, { parent, schema, strict, ...options }?: DocumentContext | undefined);
    /** @override */
    ...
    /** @override */
    override _initializationOrder(): Generator<(string | foundry.data.fields.DataField | undefined)[], void, unknown>;
     ...
     */
    getUserLevel(user?: BaseUser | undefined): DocumentOwnershipNumber;
    /**
     ...
     */
    clone(data?: object | undefined, context?: (foundry.abstract.types._DataModelConstructionOptions & Pick<foundry.abstract.types.DataModelValidationOptions, "dropInvalidEmbedded" | "fallback" | "strict"> & foundry.abstract.types._DocumentConstructionContext & DocumentCloneOptions) | undefined): Document | Promise<Document>;
    /**
     ...
     */
    update(data?: object | undefined, operation?: Partial<Omit<DatabaseUpdateOperation, "updates">> | undefined): Promise<Document | undefined>;
    /**
     * Delete this Document, removing it from the database.
     * @see {@link Document.deleteDocuments}
     * @param {Partial<Omit<DatabaseDeleteOperation, "ids"|"deleteAll">>} [operation={}]  Parameters of the deletion
     *                                                                                    operation
     ...
     * @returns {Promise<Document[]>}                   An array of updated Document instances
     */
    updateEmbeddedDocuments(embeddedName: string, updates?: object[], operation?: DatabaseUpdateOperation | undefined): Promise<Document[]>;
    /**
