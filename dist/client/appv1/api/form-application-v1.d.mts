...
export default class FormApplication extends Application {
     ...
     *                                                                  the sheet.
     */
    constructor(object?: object, options?: (FormApplicationOptions & ApplicationV1Options) | undefined);
    /**
     ...
     * @returns {Promise<ProseMirror.EditorView>}
     */
    activateEditor(name: string, options?: object, initialContent?: string): Promise<ProseMirror.EditorView>;
    /**
     ...
     */
    submit(options?: object | undefined): Promise<this>;
    /**
