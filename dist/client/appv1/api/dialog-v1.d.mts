...
export default class Dialog extends Application {
     ...
     */
    static wait(data?: DialogData | undefined, options?: (ApplicationV1Options & DialogV1Options) | undefined, renderOptions?: object | undefined): Promise<any>;
    /**
     ...
     */
    constructor(data: DialogData, options?: (ApplicationV1Options & DialogV1Options) | undefined);
    data: DialogData;
    /** @inheritdoc */
