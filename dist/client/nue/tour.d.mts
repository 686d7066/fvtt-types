...
export default class Tour {
     ...
     * @type {Tour|null}
     */
    static "__#336@#activeTour": Tour | null;
     ...
     * @param {number} [options.padding]                   Padding (px) around the element. Defaults to
     *                                                     Tour.HIGHLIGHT_PADDING.
     * @param {boolean} [options.preventInteraction=true]  Whether user interaction should be prevented while the
     *                                                     highlight is in effect.
     * @returns {HTMLElement}                              The created fadeout element, already appended to document.body.
     */
    static highlightElement(element: HTMLElement, { padding, preventInteraction }?: {
...
export type TourStep = {
     ...
     * be attempted to be auto-selected.
     */
    tooltipDirection?: "LEFT" | "RIGHT" | "CENTER" | "UP" | "DOWN" | undefined;
    /**
