...
export default class Combat extends BaseCombat {
     ...
     */
    activate(options?: Partial<DatabaseUpdateOperation> | undefined): Promise<this>;
    /** @override */
     ...
     *                                                keep the turn on the same Combatant.
     * @param {string} [options.messageMode]          A message visibility mode to apply to the resulting chat message,
     *                                                a key of {@link CONFIG.ChatMessage.modes}
     ...
     */
    rollInitiative(ids: string | string[], { formula, updateTurn, messageMode, messageOptions }?: {
     ...
     * @returns {Promise<this>}
     */
    rollAll(options?: object | undefined): Promise<this>;
    /**
     * Roll initiative for all non-player actors who have not already rolled
     * @param {object} [options={}]   Additional options forwarded to the Combat.rollInitiative method
     * @returns {Promise<this>}
     */
    rollNPC(options?: object | undefined): Promise<this>;
    /**
     ...
     * @protected
     */
    protected _getCurrentState(combatant?: Combatant | undefined): CombatHistoryData;
    /**
