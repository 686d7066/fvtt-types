 ...
 * @import {RollTableHTMLEmbedConfig} from "../_types.mjs";
...
export default class RollTable extends BaseRollTable {
    ...
    } | undefined): Promise<foundry.abstract.Document<object, foundry.abstract.types.DocumentConstructionContext> | foundry.abstract.Document<object, foundry.abstract.types.DocumentConstructionContext>[] | undefined>;
    /**
     ...
     * @param {string} [options.messageMode]          A chat message visibility mode to apply to the resulting message
     * @returns {Promise<{RollTableDraw}>}  A Promise which resolves to an object containing the executed roll and the
     *                                      produced results.
     */
    draw({ roll, recursive, results, displayChat, messageMode, rollMode }?: {
        roll?: Roll | undefined;
     ...
     */
    drawMany(number: number, { roll, recursive, displayChat, messageMode, rollMode }?: {
        roll?: Roll | undefined;
        recursive?: boolean | undefined;
        displayChat?: boolean | undefined;
        messageMode?: string | undefined;
     ...
     * ```
     */
    protected _buildEmbedHTML(config: RollTableHTMLEmbedConfig, options?: any): Promise<HTMLElement | null>;
    /** @inheritDoc */
...
import type { RollTableHTMLEmbedConfig } from "../_types.mjs";
