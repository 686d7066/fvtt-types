 ...
 * @import {ManageCompendiumResponse, ToCompendiumOptions, WorldCompendiumConfiguration,
 *   WorldCompendiumPackConfiguration} from "../../_types.mjs";
...
export default class CompendiumCollection<TDocument extends Document> extends DocumentCollection<TDocument> {
     ...
     */
    static get CONFIG_FIELD(): fields.TypedObjectField;
    static "__#203@#CONFIG_FIELD": any;
    /**
     * The cached value of the compendiumConfiguration setting.
     * @type {WorldCompendiumConfiguration}
     */
    static "__#203@#config": WorldCompendiumConfiguration;
    /**
     ...
     */
    static "__#203@#handleCreateCompendium"({ result }: ManageCompendiumResponse): CompendiumCollection<any>;
    /**
     * Handle a response from the server where a compendium was deleted.
     * @param {ManageCompendiumResponse} response  The server response.
     * @returns {CompendiumCollection}
     */
    static "__#203@#handleDeleteCompendium"({ result }: ManageCompendiumResponse): CompendiumCollection<any>;
    /**
     ...
     */
    get ownership(): Record<"PLAYER" | "TRUSTED" | "ASSISTANT" | "GAMEMASTER", "INHERIT" | "NONE" | "LIMITED" | "OBSERVER" | "OWNER">;
    /**
    ...
    /** @inheritDoc */
    set(id: any, document: any): this | CompendiumFolderCollection;
    /**
    ...
    /** @inheritDoc */
    importDocument(document: any, options?: {}): Promise<Document<object, foundry.abstract.types.DocumentConstructionContext> | undefined>;
    /** @override */
     ...
     */
    importDialog(options?: object | undefined): Promise<TDocument[] | boolean | null>;
    /**
    ...
    } | undefined): Promise<CompendiumCollection<any>>;
    /** @inheritDoc */
...
import type { WorldCompendiumConfiguration } from "../../_types.mjs";
import type { ManageCompendiumResponse } from "../../_types.mjs";
