...
export default class Users extends WorldCollection<User> {
     ...
     */
    static "__#102@#handleUserActivity"(userId: string, activityData?: ActivityData): void;
    /**
     ...
     */
    static "__#102@#handleUserQuery"(userId: string, queryId: string, queryName: string, queryData: object, { timeout }: {
