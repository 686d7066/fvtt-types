 ...
 * @import {ShareImageConfig} from "../../applications/apps/image-popout.mjs";
...
export default class Journal extends WorldCollection<JournalEntry> {
     ...
     * @param {ApplicationV2} [options.parent]                    A parent Application to register the dialog as a child
     *                                                            of.
     * @param {ApplicationRenderOptions} [options.renderOptions]  Options to forward to the dialog render call.
     * @returns {Promise<void>}
     */
    static showDialog(doc: JournalEntry | JournalEntryPage, { parent, renderOptions }?: {
        parent?: any;
    ...
    } | undefined): Promise<JournalEntry | JournalEntryPage | void>;
    /**
     ...
     */
    static showImage(src: string, { users, ...options }?: ShareImageConfig | undefined): void;
    /**
...
import type { ShareImageConfig } from "../../applications/apps/image-popout.mjs";
