...
export default class WorldCollection<TDocument extends Document> extends DocumentCollection<TDocument> {
     ...
     * This method is a convenience wrapper around the underlying {@link WorldCollection#importDocument} workflow.
     ...
     * @param {FromCompendiumOptions|DatabaseCreateOperation} [options] Options passed to
     *                                                                  {@link WorldCollection#importDocument}
     * @returns {Promise<TDocument>}   The imported Document instance
     */
    importFromCompendium(pack: CompendiumCollection<any>, id: string, updateData?: object | undefined, options?: FromCompendiumOptions | DatabaseCreateOperation): Promise<TDocument>;
    /** @override */
    override _prepareImportDocument(document: any, options: any): object;
    /**
     ...
     */
    fromCompendium(document: TDocument | object, { clearFolder, clearState, clearSort, clearOwnership, keepId }?: FromCompendiumOptions | undefined): object;
}
