...
export default class JournalEntryPage extends BaseJournalEntryPage {
    ...
    } | undefined): Record<string, JournalEntryPageHeading>;
    /**
    ...
    protected static _makeHeadingNode(heading: HTMLHeadingElement, { includeElement }?: {
        includeElement?: boolean | undefined;
    } | undefined): JournalEntryPageHeading;
    /**
     ...
     * ```
     */
    protected _embedTextPage(config: DocumentHTMLEmbedConfig & EnrichmentOptions, options?: any): Promise<HTMLElement | HTMLCollection | null>;
    /**
     ...
     * ```
     */
    protected _embedImagePage({ alt, label }: DocumentHTMLEmbedConfig, options?: any): Promise<HTMLElement | HTMLCollection | null>;
}
...
import type Note from "../canvas/placeables/note.mjs";
