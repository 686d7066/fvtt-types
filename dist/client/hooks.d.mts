 ...
 */
/**
 * @import {CanvasTearDownOptions, CanvasViewPosition, HotReloadData} from "./_types.mjs";
 * @import {CombatHistoryData, EffectChangeData, TokenMovementOperation,
 *   TokenPreMovementOperation} from "./documents/_types.mjs";
 ...
 * @import {Actor, Adventure, Card, Cards, ChatMessage, ChatSpeakerData, Combat, Level, RollTable, Scene, TokenDocument,
 ...
 */
export function canvasTearDown(canvas: Canvas, options: CanvasTearDownOptions): void;
/**
 ...
 * @event
 * @category Canvas
 * @param {Scene} scene    The Scene the edges are initialized for
 */
export function initializeEdges(scene: Scene): void;
/**
 ...
 */
export function preRenderApplication(application: ApplicationV2, context: ApplicationRenderContext, options: ApplicationRenderOptions): void;
/**
 ...
 * @param {ContextMenuEntry[]} menuItems  An array of prepared menu items which should be mutated by the hook.
 */
export function getPlaceableContextOptions(application: ApplicationV2, menuItems: ContextMenuEntry[]): void;
/**
 ...
 * @event
 * @category ApplicationV2
 * @param {string} id        The window's unique identifier.
 * @param {WindowProxy} win  The window instance.
 */
export function openDetachedWindow(id: string, win: WindowProxy): void;
/**
 ...
 * @param {WindowProxy} win  The window instance.
 */
export function closeDetachedWindow(id: string, win: WindowProxy): void;
/**
 ...
 */
export function drawGroup(group: CanvasGroup, options: object): void;
/**
 ...
 */
export function tearDownGroup(group: CanvasGroup, options: CanvasTearDownOptions): void;
/**
 ...
 */
export function drawLayer(layer: CanvasLayer, options: object): void;
/**
 ...
 */
export function tearDownLayer(layer: CanvasLayer, options: CanvasTearDownOptions): void;
/**
 ...
 * @param {TokenDocument} document                                       The existing Token document which is updated
 * @param {TokenPreMovementOperation} movement                           The pending movement of the Token
 * @param {Partial<Omit<DatabaseUpdateOperation, "updates">>} operation  The update operation that contains the movement
 * @returns {boolean|void}                                               If false, the movement is prevented
 */
export function preMoveToken(document: TokenDocument, movement: TokenPreMovementOperation, operation: Partial<Omit<DatabaseUpdateOperation, "updates">>): boolean | void;
/**
 ...
 * @event
 * @category TokenDocument
 * @param {TokenDocument} document                           The existing Token document which was updated
 ...
 */
export function moveToken(document: TokenDocument, movement: TokenMovementOperation, operation: Partial<DatabaseUpdateOperation>, user: User): void;
/**
 * A hook event that fires when the current movement of a Token document is stopped.
 * @event
 * @category TokenDocument
 * @param {TokenDocument} document                      The Token document whose movement was stopped
 */
 ...
 * @event
 * @category TokenDocument
 * @param {TokenDocument} document                      The Token document whose movement was paused
 */
 ...
 * @event
 * @category TokenDocument
 * @param {TokenDocument} document                      The Token document whose movement was planned
 */
export function planToken(document: TokenDocument): void;
/**
 * A hook event that fires when the movement of a Token document is recorded or cleared.
 * @event
 * @category TokenDocument
 * @param {TokenDocument} document                      The Token document whose movement was recorded or cleared
 */
 ...
 * @param {{delta: number}} updateOptions.worldTime    The amount of time in seconds that time is being advanced
 ...
 * @param {object} options         Options to configure activation.
 * @param {string} initialContent  The initial editor content.
 * @deprecated since v14 until v16
 */
export function activateEditorLegacy(editor: any, options: object, initialContent: string): void;
...
import type { TokenPreMovementOperation } from "./documents/_types.mjs";
