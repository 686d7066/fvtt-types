...
export default class Game {
     ...
     * @type {boolean}
     */
    static "__#389@#unloading": boolean;
    /**
     ...
     */
    static "__#389@#socketEventBuffer": Array<Readonly<[string, ...any]>>;
    /**
     ...
     */
    static "__#389@#bufferSocketEvents"(args_0: string, ...args: any[]): void;
    /**
     * Apply the queue of buffered socket events to game data once the game is ready.
     */
    static "__#389@#applyBufferedSocketEvents"(): void;
    /**
     ...
     */
    static "__#389@#handleMouseWheelInputChange"(event: WheelEvent): void;
    /**
     ...
     */
    constructor(view: string, data: object, socket: io.Socket);
    /**
     ...
     * @template T
     * @param {Promise<T>} promise  The promise that is raced against the promise of the browser window becoming hidden
     * @returns {Promise<T|void>}   The promise of the race
     */
    raceWithWindowHidden<T>(promise: Promise<T>): Promise<T | void>;
    /**
     ...
     * @param {globalThis.Document} document  The document to bind listeners to.
     */
