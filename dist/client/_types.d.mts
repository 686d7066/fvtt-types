...
export type TokenCreateTerrainMovementPathOptions = {
    /**
     * Constrain a preview path? Default: `false`.
     */
    preview?: boolean | undefined;
...
export type TokenFindMovementPathOptions = {
     ...
     */
    constrainOptions?: Omit<TokenConstrainMovementPathOptions, "preview" | "measureOptions"> | undefined;
    /**
     * The measure options.
     */
    measureOptions?: Omit<TokenMeasureMovementPathOptions, "preview"> | undefined;
...
export type TokenPlannedMovementWaypoint = Omit<TokenMeasuredMovementWaypoint, "userId" | "movementId" | "subpathId">;
...
export type _TokenRulerWaypoint = {
    /**
...
export type TokenRulerWaypoint = Omit<TokenMeasuredMovementWaypoint, "movementId" | "subpathId"> & _TokenRulerWaypoint;
export type TokenDragContext = {
    token: Token;
    clonedToken: Token;
    origin: TokenPosition;
    destination: TokenMovementWaypoint;
...
export type TokenPanningOptions = {
    /**
...
export type TokenMovementActionConfigDescriptor = {
    /**
     ...
     */
    getAnimationOptions?: ((token: TokenDocument) => Pick<TokenAnimationOptions, "duration" | "movementSpeed" | "easing" | "ontick">) | undefined;
    /**
    ...
    /**
     * Derive the terrain difficulty from this movement action. If `null`, the terrain difficulty
     ...
     */
    getCostFunction?: ((token: TokenDocument, options: TokenMeasureMovementPathOptions) => TokenMovementActionCostFunction) | undefined;
};
export type TokenMovementActionConfig = {
     ...
     */
    getAnimationOptions: (token: TokenDocument) => Pick<TokenAnimationOptions, "duration" | "movementSpeed" | "easing" | "ontick">;
    /**
     *   Can the current User select this movement action for the given Token? If selectable, the movement action of the
...
export type CanvasAnimationPanOptions = {
    /**
    ...
    speed?: number | undefined;
    /**
     * An easing function passed to {@link foundry.canvas.animation.CanvasAnimation.animate}.
     * Default: `"easeInOutCosine"`.
     */
    easing?: string | Function | undefined;
};
...
export type ToCompendiumOptions = {
    /**
...
export type CanvasTearDownOptions = {
    /**
...
import type { TokenPosition } from "./documents/_types.mjs";
...
import type { TokenMovementSegmentData } from "./documents/_types.mjs";
...
import type { SceneDimensions } from "./documents/_types.mjs";
