...
export default class DiceTerm extends RollTerm {
    ...
    /**
     * The argument portion of a modifier string (e.g., "3" of "min3")
     * @type {string}
     */
    static "__#16@#MODIFIER_ARG_REGEXP_STRING": string;
    /**
    ...
    } | undefined): RegExpMatchArray | null;
    /**
     ...
     * @protected
     */
    protected _evaluateAsync(options?: object | undefined): Promise<DiceTerm>;
    /**
    ...
    roll({ minimize, maximize, ...options }?: {
        minimize?: boolean | undefined;
        maximize?: boolean | undefined;
    } | undefined): Promise<DiceTermResult>;
    /**
     ...
     * @protected
     */
    protected _roll(options?: object | undefined): Promise<number | void>;
    /**
