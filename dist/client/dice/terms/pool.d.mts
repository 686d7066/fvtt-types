...
export default class PoolTerm extends RollTerm {
     ...
     */
    static fromExpression(formula: string, options?: object | undefined): PoolTerm | null;
    /**
     ...
     * @protected
     */
    protected _evaluateAsync(options?: object | undefined): Promise<PoolTerm>;
    /**
     ...
     * @protected
     */
    protected _evaluateSync(options?: object | undefined): PoolTerm;
    /**
