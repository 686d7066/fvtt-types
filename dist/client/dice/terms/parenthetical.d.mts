...
export default class ParentheticalTerm extends RollTerm {
     ...
     * ```
     */
    static fromTerms(terms: RollTerm[], options?: object | undefined): ParentheticalTerm;
    /** @override */
     ...
     * @protected
     */
    protected _evaluateAsync(roll: Roll, options?: object | undefined): Promise<RollTerm>;
    /**
     ...
     * @protected
     */
    protected _evaluateSync(roll: Roll, options?: object | undefined): RollTerm;
}
