...
export default class RollParser {
     ...
     * @protected
     */
    protected _onExpression(head: RollParseNode, tail: [string[], RollParseNode][], leading?: string | undefined, formula: string, error: Function): RollParseTreeNode;
    /**
     * Handle a dice term.
     ...
     * @param {string} formula                                               The original matched text.
     * @param {RollParseOffset} offset                                       The position of the matched term in the
     *                                                                       formula string.
     * @returns {DiceRollParseNode}
     * @protected
     */
    protected _onDiceTerm(number: NumericRollParseNode | ParentheticalRollParseNode | null, faces: string | NumericRollParseNode | ParentheticalRollParseNode | null, modifiers: string | null, flavor: string | null, formula: string, offset: RollParseOffset): DiceRollParseNode;
    /**
     * Handle a numeric term.
     * @param {number} number           The number.
     * @param {string} flavor           Associated flavor text.
     * @param {RollParseOffset} offset  The position of the matched term in the formula string.
     * @returns {NumericRollParseNode}
     * @protected
     */
    protected _onNumericTerm(number: number, flavor: string, offset: RollParseOffset): NumericRollParseNode;
    /**
     * Handle a math term.
     ...
     * @protected
     */
    protected _onFunctionTerm(fn: string, head: RollParseNode, tail: RollParseNode[], flavor: string, formula: string, offset: RollParseOffset): FunctionRollParseNode;
    /**
     * Handle a pool term.
     * @param {RollParseNode} head      The first term.
     * @param {RollParseNode[]} tail    Zero or more additional terms.
     ...
     * @protected
     */
    protected _onPoolTerm(head: RollParseNode, tail: RollParseNode[], modifiers: string | null, flavor: string | null, formula: string, offset: RollParseOffset): PoolRollParseNode;
    /**
     ...
     * @protected
     */
    protected _onParenthetical(term: RollParseNode, flavor: string | null, formula: string, offset: RollParseOffset): ParentheticalRollParseNode;
    /**
     ...
     * @protected
     */
    protected _onStringTerm(term: string, flavor?: string | null | undefined, offset: RollParseOffset): StringParseNode;
    /**
