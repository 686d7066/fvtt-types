 ...
 * @import {ReplaceFormulaDataOptions, RollOptions, RollParseNode} from "./_types.mjs";
...
export default class Roll {
     ...
     */
    static create(formula: string, data?: object | undefined, options?: object | undefined): Roll;
    /**
     ...
     */
    static "__#228@#replaceFormulaPatterns": {
        expression: RegExp;
        term: RegExp;
    };
    /**
     ...
     * @returns {string}
     */
    static replaceFormulaData(formula: string, data: object, options?: ReplaceFormulaDataOptions | undefined, _r?: number): string;
    /**
     ...
     */
    constructor(formula?: string, data?: object, options?: RollOptions | undefined);
    /**
     ...
     */
    alter(multiply: number, add: number, { multiplyNumeric }?: boolean | undefined): Roll;
    /**
    ...
    protected _evaluateASTAsync(node: RollParseNode | RollTerm, options?: {
        ...
        maximize?: boolean | undefined;
        allowStrings?: boolean | undefined;
    } | undefined): Promise<string | number>;
    /**
     ...
     */
    reroll(options?: object | undefined): Promise<Roll>;
    /**
     ...
     * @param {string} [options.messageMode]    A message visibility mode to apply to the resulting message.
     * @param {boolean} [options.create=true]   Whether to automatically create the chat message, or only return the
     *                                          prepared chatData object.
     * @returns {Promise<ChatMessage|object>} A promise which resolves to the created ChatMessage document if create is
     *                                        true, or the Object of prepared chatData otherwise.
     */
    toMessage(messageData?: object, { messageMode, rollMode, create }?: {
        messageMode?: string | undefined;
        create?: boolean | undefined;
    } | undefined): Promise<ChatMessage | object>;
    /**
...
import type { ReplaceFormulaDataOptions } from "./_types.mjs";
