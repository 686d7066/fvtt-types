...
export namespace Adventure {
    ...
    let embedHandlers_1: DocumentEmbedHandler[];
    export { embedHandlers_1 as embedHandlers };
...
export namespace Cards {
    ...
    let embedHandlers_2: DocumentEmbedHandler[];
    export { embedHandlers_2 as embedHandlers };
    ...
    let typeHints_1: Record<string, string>;
    export { typeHints_1 as typeHints };
...
export namespace ChatMessage {
    ...
    let embedHandlers_3: DocumentEmbedHandler[];
    export { embedHandlers_3 as embedHandlers };
    ...
    let typeHints_2: Record<string, string>;
    export { typeHints_2 as typeHints };
    let typeIcons_2: Record<string, string>;
    export { typeIcons_2 as typeIcons };
    export let batchSize: number;
    export let modes: Record<string, {
        label: string;
        icon: string;
        handler: (data: Partial<ChatMessageData>) => void;
    }>;
}
export namespace Combat {
    let documentClass_4: typeof documents.Combat;
    export { documentClass_4 as documentClass };
    let embedHandlers_4: DocumentEmbedHandler[];
    export { embedHandlers_4 as embedHandlers };
    ...
    let typeHints_3: Record<string, string>;
    export { typeHints_3 as typeHints };
...
export namespace Item {
    ...
    let embedHandlers_5: DocumentEmbedHandler[];
    export { embedHandlers_5 as embedHandlers };
    ...
    let typeHints_4: Record<string, string>;
    export { typeHints_4 as typeHints };
...
export namespace JournalEntry {
    ...
    let embedHandlers_6: DocumentEmbedHandler[];
    export { embedHandlers_6 as embedHandlers };
...
export namespace Macro {
    ...
    let embedHandlers_7: DocumentEmbedHandler[];
    export { embedHandlers_7 as embedHandlers };
...
export namespace Playlist {
    ...
    let embedHandlers_8: DocumentEmbedHandler[];
    export { embedHandlers_8 as embedHandlers };
...
export namespace RollTable {
    ...
    let embedHandlers_9: DocumentEmbedHandler[];
    export { embedHandlers_9 as embedHandlers };
...
export namespace Scene {
    ...
    let embedHandlers_10: DocumentEmbedHandler[];
    export { embedHandlers_10 as embedHandlers };
...
export namespace Canvas {
    ...
    let sceneTransitions: Record<string, SceneTransitionDefinition>;
    let managedScenes: Record<string, typeof canvas.SceneManager | canvas.SceneManager>;
    namespace pings {
        namespace types {
            let PULSE: string;
            let ALERT: string;
    ...
    const visionModes: Record<string, canvas.perception.VisionMode>;
    const detectionModes: Record<string, canvas.perception.DetectionMode>;
    namespace transcoders {
        let basis: boolean;
    }
    namespace vfx {
        let enabled: boolean;
        let components: Record<string, typeof canvas.vfx.VFXComponent>;
        let animations: Record<string, VFXComponentAnimation>;
        let paths: Record<string, VFXPathGenerator>;
    }
}
/**
 ...
 */
/**
 * @typedef {ParticleGeneratorConfiguration} WeatherParticleConfiguration
 * @property {typeof foundry.canvas.animation.ParticleGenerator} [generatorClass]
 *   An optional ParticleGenerator subclass to instantiate. Defaults to ParticleGenerator.
 */
/**
 * @typedef WeatherEffectConfiguration
 * @property {string} id
 * @property {typeof canvas.rendering.shaders.WeatherShaderEffect} [effectClass]
 ...
 * @property {WeatherParticleConfiguration[]} [particles]
 */
 ...
 * @property {number} [order=0]                An integer indicating the order
 ...
 * @type {{[id: string]: StatusEffectConfig}}
 */
export const statusEffects: {
    [id: string]: StatusEffectConfig;
};
/**
...
export namespace i18n {
    ...
    let searchStopWords: Set<string>;
}
...
export namespace ActiveEffect {
    let compendiumBanner_9: string;
    export { compendiumBanner_9 as compendiumBanner };
    let documentClass_15: typeof documents.ActiveEffect;
    export { documentClass_15 as documentClass };
    let dataModels_5: Record<string, typeof data.ActiveEffectTypeDataModel>;
    export { dataModels_5 as dataModels };
    export let defaultType: string;
    let embedHandlers_11: DocumentEmbedHandler[];
    export { embedHandlers_11 as embedHandlers };
    let typeLabels_5: Record<string, string>;
    export { typeLabels_5 as typeLabels };
    let typeHints_5: Record<string, string>;
    export { typeHints_5 as typeHints };
    ...
    export let changeTypes: Record<string, ActiveEffectChangeTypeConfig>;
    export let expiryEvents: Record<string, string>;
    export let expiryAction: "update" | "delete" | null;
    export let phases: Record<string, {
        label: string;
        hint: string;
    }>;
}
...
export namespace Card {
    ...
    let embedHandlers_12: DocumentEmbedHandler[];
    export { embedHandlers_12 as embedHandlers };
    let typeLabels_6: Record<string, string>;
    export { typeLabels_6 as typeLabels };
    let typeHints_6: Record<string, string>;
    export { typeHints_6 as typeHints };
...
export namespace TableResult {
    ...
    let embedHandlers_13: DocumentEmbedHandler[];
    export { embedHandlers_13 as embedHandlers };
}
export namespace JournalEntryCategory {
    ...
    let embedHandlers_14: DocumentEmbedHandler[];
    export { embedHandlers_14 as embedHandlers };
}
export namespace JournalEntryPage {
    ...
    let embedHandlers_15: DocumentEmbedHandler[];
    export { embedHandlers_15 as embedHandlers };
    let typeLabels_7: Record<string, string>;
    export { typeLabels_7 as typeLabels };
    let typeHints_7: Record<string, string>;
    export { typeHints_7 as typeHints };
    let typeIcons_7: Record<string, string>;
    export { typeIcons_7 as typeIcons };
    let defaultType_1: string;
    export { defaultType_1 as defaultType };
...
export namespace PlaylistSound {
    ...
    let embedHandlers_16: DocumentEmbedHandler[];
    export { embedHandlers_16 as embedHandlers };
    let sidebarIcon_14: string;
    export { sidebarIcon_14 as sidebarIcon };
}
export namespace AmbientLight {
    ...
    export namespace sidebar {
        let applicationClass: typeof applications.sidebar.tabs.AmbientLightTab;
        let order: number;
    }
}
export namespace AmbientSound {
    ...
    export namespace sidebar_1 {
        let applicationClass_1: typeof applications.sidebar.tabs.AmbientSoundTab;
        export { applicationClass_1 as applicationClass };
        let order_1: number;
...
export namespace Combatant {
    ...
    let embedHandlers_17: DocumentEmbedHandler[];
    export { embedHandlers_17 as embedHandlers };
    let typeLabels_8: Record<string, string>;
    export { typeLabels_8 as typeLabels };
    let typeHints_8: Record<string, string>;
    export { typeHints_8 as typeHints };
...
export namespace CombatantGroup {
    ...
    let embedHandlers_18: DocumentEmbedHandler[];
    export { embedHandlers_18 as embedHandlers };
    let typeLabels_9: Record<string, string>;
    export { typeLabels_9 as typeLabels };
    let typeHints_9: Record<string, string>;
    export { typeHints_9 as typeHints };
...
export namespace Drawing {
    ...
    export namespace sidebar_2 {
        let applicationClass_2: typeof applications.sidebar.tabs.DrawingTab;
        export { applicationClass_2 as applicationClass };
        let order_2: number;
    ...
    export namespace sheetClasses {
        let base: {
            "core.MeasuredTemplateConfig": {
                ...
                default: boolean;
                cls: typeof applications.sheets.MeasuredTemplateConfig;
            };
        };
    }
    const types_1: {};
...
export namespace Note {
    ...
    export namespace sidebar_3 {
        let applicationClass_3: typeof applications.sidebar.tabs.NoteTab;
        export { applicationClass_3 as applicationClass };
        let order_3: number;
        export { order_3 as order };
    }
    export { sidebar_3 as sidebar };
}
export namespace Region {
    ...
    export namespace sidebar_4 {
        let applicationClass_4: typeof applications.sidebar.tabs.RegionTab;
        export { applicationClass_4 as applicationClass };
        let order_4: number;
        export { order_4 as order };
    }
    export { sidebar_4 as sidebar };
}
export namespace RegionBehavior {
    ...
    let typeHints_10: Record<string, string>;
    export { typeHints_10 as typeHints };
    let typeIcons_10: Record<string, string>;
    export { typeIcons_10 as typeIcons };
}
export namespace Level {
    let documentClass_31: typeof documents.Level;
    export { documentClass_31 as documentClass };
}
export namespace Tile {
    let documentClass_32: typeof documents.TileDocument;
    ...
    export namespace sidebar_5 {
        let applicationClass_5: typeof applications.sidebar.tabs.TileTab;
        export { applicationClass_5 as applicationClass };
        let order_5: number;
        export { order_5 as order };
    }
    export { sidebar_5 as sidebar };
}
export namespace Token {
    let documentClass_33: typeof documents.TokenDocument;
    ...
    export namespace sidebar_6 {
        let applicationClass_6: typeof applications.sidebar.tabs.TokenTab;
        export { applicationClass_6 as applicationClass };
        let order_6: number;
        export { order_6 as order };
    }
    export { sidebar_6 as sidebar };
    export namespace movement {
        ...
        let actions: {
            [action: string]: TokenMovementActionConfigDescriptor;
        };
    }
...
export namespace Wall {
    let documentClass_34: typeof documents.WallDocument;
    export { documentClass_34 as documentClass };
    let objectClass_8: typeof canvas.placeables.Wall;
    export { objectClass_8 as objectClass };
    export namespace sidebar_7 {
        let applicationClass_7: typeof applications.sidebar.tabs.WallTab;
        export { applicationClass_7 as applicationClass };
        let order_7: number;
        export { order_7 as order };
    }
    export { sidebar_7 as sidebar };
...
export namespace TextEditor {
    let engines: Record<string, TextEditorEngineConfig>;
    let enrichers: TextEditorEnricherConfig[];
    let inserts: ProseMirrorInsert[];
}
...
export namespace ui {
    ...
    let sidebar_8: typeof applications.sidebar.Sidebar;
    export { sidebar_8 as sidebar };
    ...
    export let placeables: typeof applications.sidebar.tabs.PlaceableDirectory;
...
export namespace ux {
    let Autocomplete: typeof applications.ux.Autocomplete;
 ...
 * @property {Record<string, FormulaEditorContext>} contexts
 */
/**
 * @typedef FormulaEditorContext
 * @property {Record<string, string>} labels  A map of data paths to human-readable labels.
 */
/**
 * Configure the formula editor.
 * @type {FormulaEditorConfiguration}
 */
export const formulaEditor: FormulaEditorConfiguration;
export type DocumentEmbedHandler = (doc: Document, content: HTMLElement | null, config: DocumentHTMLEmbedConfig, options?: EnrichmentOptions | undefined) => Promise<HTMLElement | HTMLCollection | null>;
...
export type SceneTransitionDefinition = {
    id: string;
    label: string;
    filterClass: typeof canvas.rendering.filters.AbstractBaseFilter;
    filterType: string;
...
export type WeatherParticleConfiguration = canvas.animation.types.ParticleGeneratorConfiguration;
export type WeatherEffectConfiguration = {
    id: string;
    effectClass?: typeof canvas.rendering.shaders.WeatherShaderEffect | undefined;
    shaderClass?: typeof canvas.rendering.shaders.AbstractWeatherShader | undefined;
    blendMode?: any;
    config?: object | undefined;
    performanceLevel?: number | undefined;
    particles?: canvas.animation.types.ParticleGeneratorConfiguration[] | undefined;
};
...
export type ActiveEffectChangeTypeConfig = {
    label: string;
    defaultPriority: number;
    handler?: documents.types.ActiveEffectChangeHandler | null | undefined;
    render?: documents.types.ActiveEffectChangeRenderer | null | undefined;
};
...
export type TextEditorEngineConfig = {
    /**
...
export type TextEditorEngineFactory = (options: object, initialContent: string) => Promise<any>;
export type TextEditorEngineRenderer = (options: {
...
export type TextEditorEnricher = (match: RegExpMatchArray, options?: EnrichmentOptions | undefined) => Promise<HTMLElement | null>;
...
import type { TokenMovementActionConfigDescriptor } from "./_types.mjs";
...
import type { EnrichmentOptions } from "./applications/ux/text-editor.mjs";
