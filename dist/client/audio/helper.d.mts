...
export default class AudioHelper {
     ...
     * @type {AudioContext}
     */
    static "__#364@#analyzerContext": AudioContext;
    /**
     ...
     * @param {number} volume
     */
    static "__#364@#onChangeMusicVolume"(volume: number): void;
    /**
     * Handle changes to the global environment volume slider.
     * @param {number} volume
     */
    static "__#364@#onChangeEnvironmentVolume"(volume: number): void;
    /**
     * Handle changes to the global interface volume slider.
     * @param {number} volume
     */
    static "__#364@#onChangeInterfaceVolume"(volume: number): void;
    /**
     ...
     * @returns {number}
     */
    static inputToVolume(value: number | string, order?: number | undefined): number;
    /**
     ...
     */
    static "__#364@#createContext"(volumeSetting: any): AudioContext;
    /**
     ...
     */
    startLevelReports(id: string, stream: MediaStream, callback: Function, interval?: number | undefined, smoothing?: number | undefined): boolean;
    /**
     ...
     */
    getMaxBandLevel(band?: BandName | undefined, { ignoreVolume }?: {
        ignoreVolume?: boolean | undefined;
    } | undefined): number;
    #private;
}
