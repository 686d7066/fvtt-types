 ...
 * @property {boolean} [walls=true]                     Should the sound be constrained by walls and surfaces?
...
export default class Sound extends Sound_base {
     ...
     */
    play(options?: SoundPlaybackOptions | undefined): Promise<Sound>;
    /**
     ...
     */
    stop(options?: SoundPlaybackOptions | undefined): Promise<Sound>;
    /**
     ...
     */
    applyEffects(effects?: AudioNode[] | undefined): void;
    /**
