...
export default class WeatherEffects extends WeatherEffects_base {
     ...
     * @type {Map<string, ParticleEffect|WeatherShaderEffect|ParticleGenerator>}
     */
     ...
     */
    initializeEffects(weatherEffectsConfig?: object | undefined): void;
    /**
...
import ParticleGenerator from "../../animation/particle-generator.mjs";
export {};
