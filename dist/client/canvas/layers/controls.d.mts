 ...
 * 3) Map pings
 */
export default class ControlsLayer extends CanvasLayer {
    /** @override */
     ...
     */
    handlePing(user: User, position: Point, { scene, style, pull, zoom, ...pingOptions }?: PingData | undefined): Promise<boolean>;
    /**
