declare const LightingLayer_base: {
    new (): {
        _mouseWheelContext: {
 ...
 * @category Canvas
 */
export default class LightingLayer extends LightingLayer_base {
    /** @inheritdoc */
...
import AmbientLightPalette from "../../applications/sheets/palette/ambient-light-palette.mjs";
export {};
