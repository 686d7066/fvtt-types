/**
 * @import Quadtree from "../../geometry/quadtree.mjs";
...
export default class PlaceablesLayer extends InteractionLayer {
     ...
     * @type {Function}
     */
    static "__#199@#sortObjectsByElevationAndSort": Function;
    /**
     * @deprecated since v14
     * @ignore
     */
    static get CREATION_STATES(): {
        NONE: number;
        POTENTIAL: number;
        CONFIRMED: number;
        COMPLETED: number;
     ...
     * @type {(options: object) => Promise<PlaceableObject[]>}
     * @internal
     */
     ...
     * @returns {boolean|void}        Returns undefined if the layer does not have sortable object.
     ...
     * @protected
     */
    protected _storeHistory(type: "create" | "update" | "delete", data: object[], options?: object | undefined): void;
    /**
     ...
     * @returns {object}                     The initial document data
     * @protected
     */
    protected _createDragPreviewData(event: PIXI.FederatedEvent): object;
    /** @override */
     ...
     * @protected
     */
    protected _commitDragLeftDrop(event: PIXI.FederatedEvent): Promise<void>;
    /** @override */
    override _onDragLeftCancel(event: any): void;
    /** @override */
    override _onClickRight(event: any): false | undefined;
    /** @override */
...
import type Quadtree from "../../geometry/quadtree.mjs";
import type DocumentCollection from "../../../documents/abstract/document-collection.mjs";
import type BasePlaceableHUD from "../../../applications/hud/placeable-hud.mjs";
