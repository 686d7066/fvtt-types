declare const DrawingsLayer_base: {
    new (): {
        _mouseWheelContext: {
 ...
 * @category Canvas
 */
export default class DrawingsLayer extends DrawingsLayer_base {
    /** @inheritdoc */
...
import DrawingPalette from "../../applications/sheets/palette/drawing-palette.mjs";
export {};
