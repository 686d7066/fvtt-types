/**
 * @import {ActivityData, CanvasAnimationPanOptions, CanvasDimensions, CanvasPerformanceSettings,
 *   CanvasSupportedComponents, CanvasTearDownOptions, CanvasViewPosition, Point} from "../_types.mjs";
 ...
 * @import {SceneViewOptions} from "../documents/_types.mjs";
...
export default class Canvas {
     ...
     */
    static "__#168@#configureWebGL"(): void;
    /**
     ...
     */
    static "__#168@#createHTMLCanvas"(): HTMLCanvasElement;
    /**
     ...
     */
    static "__#168@#configureCanvasSettings"(): object;
    /**
     * Get a SceneManager instance used for this Scene, if any.
     * The SceneManager is created by this function if the entry in {@link CONFIG.Canvas.managedScenes} is a class.
     * @param {Scene} scene
     ...
     * @param {Scene} scene                The Scene that is about to be drawn next.
     * @param {SceneManager|null} manager  The SceneManager for this scene.
     * @returns {string}                   The Level ID.
     */
    static "__#168@#determineInitialLevel"(scene: Scene, manager: SceneManager | null): string;
    /**
     ...
     * @readonly
     */
    readonly blurFilters: Set<PIXI.Filter>;
    /**
     ...
     * @readonly
     */
    readonly supported: CanvasSupportedComponents;
    /**
     ...
     * @type {BaseGrid|null}
     */
    get grid(): BaseGrid<foundry.grid.types.GridCoordinates2D, foundry.grid.types.GridCoordinates3D> | null;
    /**
     ...
     */
    get activeLayer(): InteractionLayer;
    /**
     ...
     */
    tearDown(options?: CanvasTearDownOptions | undefined): Promise<void>;
    /**
     ...
     * @param {Set<string>} [options.levels]   Restrict to these Levels (empty means all Levels)
     * @returns {Level|null}
     */
    inferLevelFromElevation(elevation: number, { levels }?: {
        levels?: Set<string> | undefined;
    } | undefined): Level | null;
    /**
     ...
     * @param {Partial<Omit<CanvasViewPosition, "level">>} [position]  The canvas position to pan to.
     */
    pan({ x, y, scale }?: Partial<Omit<CanvasViewPosition, "level">> | undefined): void;
    /**
     ...
     *
     * @param {Omit<CanvasViewPosition, "level"> & CanvasAnimationPanOptions} view  The desired view and animation
     *                                                                              parameters.
     * @returns {Promise<boolean>}    A Promise which resolves once the animation has been completed
     */
    animatePan({ x, y, scale, duration, speed, easing }?: Omit<CanvasViewPosition, "level"> & CanvasAnimationPanOptions): Promise<boolean>;
    /**
     * Recenter the canvas with a pan animation that ends in the center of the canvas rectangle.
     * @param {Omit<CanvasViewPosition, "level">} initial  A desired initial position from which to begin the animation.
     * @returns {Promise<void>}                            A Promise which resolves once the animation has been completed.
     */
    recenter(initial: Omit<CanvasViewPosition, "level">): Promise<void>;
    /**
     ...
     * @param {Partial<Omit<CanvasViewPosition, "level">>} position  The unconstrained camera position.
     * @returns {Omit<CanvasViewPosition, "level">}                  The constrained position.
     * @internal
     */
    _constrainView({ x, y, scale }: Partial<Omit<CanvasViewPosition, "level">>): Omit<CanvasViewPosition, "level">;
    /**
     ...
     */
    registerMouseMoveHandler(handler: Function, priority?: number | undefined, context?: object | undefined, strict?: boolean | undefined): void;
    /**
     ...
     * @public
     */
    public _onDragCanvasPan(event: MouseEvent): Promise<boolean> | undefined;
    /**
...
import type { CanvasPerformanceSettings } from "../_types.mjs";
import type { CanvasSupportedComponents } from "../_types.mjs";
import FramebufferSnapshot from "./framebuffer-snapshot.mjs";
import type { SceneViewOptions } from "../documents/_types.mjs";
...
import TransitionContainer from "./transition.mjs";
import type HeadsUpDisplayContainer from "../applications/hud/container.mjs";
import Scene from "../documents/scene.mjs";
import type Level from "../documents/level.mjs";
import type CanvasEdges from "./geometry/edges/edges.mjs";
import SceneManager from "./scene-manager.mjs";
import type { CanvasDimensions } from "../_types.mjs";
...
import type { CanvasAnimationPanOptions } from "../_types.mjs";
