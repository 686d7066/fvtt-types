...
export default class PrimarySpriteMesh extends SpriteMesh {
     ...
     * @type {PIXI.Point}
     */
    static "__#37@#TEMP_POINT": PIXI.Point;
    /**
    ...
    resize(baseWidth: number, baseHeight: number, { fit, scaleX, scaleY }?: {
        fit?: "fill" | "width" | "height" | "cover" | "contain" | undefined;
     ...
     * @returns {boolean}
     */
    containsCanvasPoint(point: PIXI.IPointData, textureAlphaThreshold?: number | undefined): boolean;
    /**
     ...
     * @returns {boolean}
     */
    containsPoint(point: PIXI.IPointData, textureAlphaThreshold?: number | undefined): boolean;
    /** @override */
