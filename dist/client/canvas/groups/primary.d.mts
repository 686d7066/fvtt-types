...
export default class PrimaryCanvasGroup extends CachedContainer {
    ...
    /**
     * @param {SpriteMesh} [sprite]
     */
    constructor(sprite?: SpriteMesh | undefined);
    eventMode: string;
    /**
     ...
     * @ignore
     */
    set hoverFadeElevation(_value: any);
    /**
     * @deprecated since v14
     * @ignore
     */
    get hoverFadeElevation(): any;
    #private;
}
...
import { CanvasQuadtree } from "../geometry/quadtree.mjs";
...
import type { Token } from "../placeables/_module.mjs";
import type { Tile } from "../placeables/_module.mjs";
import type { Drawing } from "../placeables/_module.mjs";
