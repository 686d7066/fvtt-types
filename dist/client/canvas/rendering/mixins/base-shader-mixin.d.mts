...
export default function BaseShaderMixin(ShaderClass: typeof PIXI.Filter | typeof PIXI.Shader): {
     ...
     * @protected
     */
    _createVertexShader(options?: object | undefined): string;
    /**
     ...
     * @protected
     */
    _createFragmentShader(options?: object | undefined): string;
    /**
     ...
     * @abstract
     */
    create(_uniforms: any, _options: any): {
        /**
         * A one time initialization performed on creation.
         * Subclasses may override to perform custom configuration of uniforms or state.
         * @param {object} [options]   Configuration options provided at creation time.
     ...
     * @returns {string}
     */
    FBM(octaves?: number | undefined, amp?: number | undefined): string;
    /**
     ...
     */
    FBMHQ(octaves?: number | undefined, fbmFuncName?: string | undefined, noiseFuncName?: string | undefined, vecType?: string | undefined): string;
    /**
    ...
    /** @ignore */
    _fragmentShaderCompatibility(options: any): any;
    /** @ignore */
    _vertexShaderCompatibility(options: any): any;
};
