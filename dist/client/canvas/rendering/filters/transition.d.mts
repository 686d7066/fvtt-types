...
export default class TextureTransitionFilter extends AbstractBaseFilter {
     ...
     */
    static "__#146@#TYPE_NUMBER_TO_STRING": ReadonlyArray<string>;
    /**
     * Maps the type string to its number.
     * @type {Readonly<{[type: string]: number}>}
     */
    static "__#146@#TYPE_STRING_TO_NUMBER": Readonly<{
        [type: string]: number;
    }>;
    /**
     ...
     * @type {ReadonlyArray<string>}
     */
    static "__#146@#PADDED_TYPES": ReadonlyArray<string>;
    /**
