...
export default class SpriteMesh {
     ...
     * @type {PIXI.Rectangle}
     */
    static "__#22@#TEMP_RECT": PIXI.Rectangle;
    /**
     * A temporary reusable point.
     * @type {PIXI.Point}
     */
    static "__#22@#TEMP_POINT": PIXI.Point;
    /**
     ...
     * @returns {SpriteMesh}
     */
    static from(source: string | PIXI.Texture | HTMLCanvasElement | HTMLVideoElement, textureOptions?: object | undefined, shaderClass?: BaseSamplerShader | undefined): SpriteMesh;
    ...
    /** @override */
    override _renderWithCulling(renderer: any): any;
    /** @override */
