...
export default class CanvasAnimation {
     ...
     */
    static "__#34@#animateFrame"(elapsedMS: number, animation: CanvasAnimationData): void;
    /**
     ...
     */
    static "__#34@#updateAttribute"(attribute: CanvasAnimationAttribute, percentage: number): void;
}
