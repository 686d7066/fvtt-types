...
export default class ChatBubbles {
     ...
     */
    broadcast(token: TokenDocument, message: string, options?: ChatBubbleOptions | undefined): Promise<HTMLElement | null>;
    /**
     ...
     */
    say(token: Token, message: string, { cssClasses, requireVisible, pan }?: ChatBubbleOptions | undefined): Promise<HTMLElement | null>;
    /**
