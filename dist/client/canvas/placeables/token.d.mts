 ...
 * @import {TokenCoordinates, TokenDetectionMode, TokenDimensions, TokenPosition} from "../../../common/documents/_types.mjs";
 * @import {DatabaseUpdateOperation} from "../../../common/abstract/_types.mjs";
 * @import {GridMeasurePathResult} from "../../../common/grid/_types.mjs";
 * @import {
 *   TokenFindMovementPathJob, TokenDragContext, TokenConstrainMovementPathOptions, TokenMeasureMovementPathOptions,
 *   TokenFindMovementPathOptions, TokenAnimationContext, TokenAnimationData, TokenAnimationOptions, ReticuleOptions,
 *   TokenAnimationTransition, TokenPlannedMovement, TokenCreateTerrainMovementPathOptions, TokenPanningOptions,
 * } from "../../_types.mjs";
 * @import {
 *   TokenMovementCostFunction, TokenProcessedMovementWaypoint,
 *   TokenMeasuredMovementWaypoint, TokenMovementWaypoint, TokenMeasurableMovementWaypoint, TokenMovementOptions
 ...
 * @import {Actor, Combatant, RegionDocument, User} from "../../documents/_module.mjs";
 * @import {EdgeRestrictionType} from "../../../common/constants.mjs";
 */
/**
...
export default class Token extends PlaceableObject {
     ...
     */
    static "__#213@#DETECTION_FILTER_ARRAY": [detectionFilter: PIXI.Filter | null];
    /**
     ...
     */
    static "__#213@#getMovementAdjustedPoint"(point: Point, offsetX: number, offsetY: number): Point;
    /**
     * Does the token position need movement adjustment?
     * @param {Point} origin   The movement origin
     * @returns {boolean}      Adjustment needed?
     */
    static "__#213@#needsMovementAdjustment"(origin: Point): boolean;
    /**
     ...
     */
    static "__#213@#getMovementAnimationDuration"(from: Omit<TokenPosition, "elevation" | "shape" | "level">, to: Partial<Omit<TokenPosition, "elevation" | "shape" | "level">>, movementSpeed: number): number;
    /**
     ...
     */
    static "__#213@#handleRotationChanges"(from: DeepReadonly<TokenAnimationData>, changes: Partial<TokenAnimationData>): void;
    /**
     ...
     */
    static "__#213@#updatePadding"(sourceMesh: PrimarySpriteMesh, targetMesh: PrimarySpriteMesh): void;
    /**
     ...
     */
    static "__#213@#updateDragPreview"(preview: Token, destination: Partial<TokenPosition>): void;
    /**
     * Update the planned movement path.
     * @param {TokenDragContext} context    The drag context
     */
    static "__#213@#recalculatePlannedMovementPath"(context: TokenDragContext): void;
    /**
     * Copy the given position.
     * @param {TokenPosition} position
     * @returns {TokenPosition}
     */
    static "__#213@#copyPosition"(position: TokenPosition): TokenPosition;
    /**
     *
     ...
     * @type {{[id: string]: TokenDetectionMode}}
     */
    get detectionModes(): {
        [id: string]: TokenDetectionMode;
    };
    /** @override */
    override get isInteractable(): any;
    /**
     ...
     * @param {Iterable<string>|null} [options.allowedActions]
     *   The possible movement actions that can be used to this planned movement.
     *   Default: `null` (all selectable movement actions).
     * @param {boolean} [options.direct]      Only allow direct movement between the origin and destination?
     *                                        Default: `false`.
     * @param {number} [options.minCost]      The minimum cost of this planned movement at the time of the planning.
     *                                        The actual cost of the movement when it is executed might be less than
     *                                        the minimum cost. Default: `0`.
     * @param {number} [options.maxCost]      The maximum cost of this planned movement at the time of the planning.
     *                                        The actual cost of the movement when it is executed might be greater than
     *                                        the maximum cost. Default: `Infinity`.
     * @param {number} [options.minDistance]  The minimum distance of this planned movement at the time of the planning.
     *                                        The actual cost of the movement when it is executed might be less than
     *                                        the minimum cost. Default: `0`.
     * @param {number} [options.maxDistance]  The maximum distance of this planned movement at the time of the planning.
     *                                        The actual cost of the movement when it is executed might be greater than
     *                                        the maximum cost. Default: `Infinity`.
     * @param {number} [options.preventDrop]  Prevent drop if any of the cost or distance limits are violated.
     *                                        Default: `false`.
     * @param {Omit<TokenCreateTerrainMovementPathOptions, "preview">} [options.terrainOptions]
     *                                        The terrain movement options.
     * @param {Omit<TokenConstrainMovementPathOptions, "preview"|"history"|"measureOptions">} [options.constrainOptions]
     *                                        The options to constrain movement.
     * @param {Omit<TokenMeasureMovementPathOptions, "preview">} [options.measureOptions]
     *                                        The options to measure movement.
     * @param {Omit<TokenFindMovementPathOptions, "preview"|"terrainOptions"|"constrainOptions"|
     *   "measureOptions">} [options.pathfindingOptions]
     *                                        The pathfinding options.
     * @param {Omit<TokenMovementOptions, "id"|"method"|"terrainOptions"|"constrainOptions"|"measureOptions"|
     *   "planned">} [options.moveOptions]    The movement options.
     * @returns {Promise<{
     *     id: string;
     *     origin: TokenPosition;
     *     destination: TokenPosition;
     *     waypoints: TokenMovementWaypoint[];
     *   }|null>}  The planned movement ID, origin, destination, and waypoints, or null if the dismiss key was pressed,
     *             the Token was released, the game was paused and the user is not a GM, or the Token is locked.
     * @see {@link foundry.documents.TokenDocument#startMovement}
     * @example
     * ```js
     ...
     */
    planMovement({ allowedActions, direct, minCost, maxCost, minDistance, maxDistance, preventDrop, terrainOptions, constrainOptions, measureOptions, pathfindingOptions, moveOptions }?: {
        ...
        pathfindingOptions?: Omit<TokenFindMovementPathOptions, "preview" | "measureOptions" | "terrainOptions" | "constrainOptions"> | undefined;
        moveOptions?: Omit<TokenMovementOptions, "id" | "method" | "planned" | "measureOptions" | "terrainOptions" | "constrainOptions"> | undefined;
    } | undefined): Promise<{
        id: string;
        origin: TokenPosition;
        destination: TokenPosition;
     ...
     * @internal
     */
    _createSharedFogVisionSource(): PointVisionSource;
    /** @inheritDoc */
     ...
     * @protected
     */
    protected _drawTargetArrows({ margin: m, alpha, size, color, border: { width, color: lineColor } }?: ReticuleOptions | undefined): void;
    /**
     ...
     * @protected
     */
    protected _drawBar(index: number, bar: PIXI.Graphics, data: object): void;
    /**
     ...
     */
    animate(to: Partial<TokenAnimationData>, options?: TokenAnimationOptions | undefined): Promise<void>;
    /**
    ...
    } | undefined): boolean | PolygonVertex | PolygonVertex[] | null;
    /**
     ...
     */
    getCenterPoint(position?: Point | undefined): Point;
    /** @override */
     ...
     */
    measureMovementPath(waypoints: TokenMeasurableMovementWaypoint[], options?: TokenMeasureMovementPathOptions | undefined): GridMeasurePathResult;
    /**
     ...
     * @protected
     */
    protected _getMovementCostFunction(options?: TokenMeasureMovementPathOptions | undefined): TokenMovementCostFunction | void;
    /**
     ...
     *   is returned.
     */
    constrainMovementPath(waypoints: Partial<TokenProcessedMovementWaypoint>[], options?: TokenConstrainMovementPathOptions | undefined): [constrainedPath: TokenProcessedMovementWaypoint[], wasConstrained: boolean];
    /**
     ...
     */
    findMovementPath(waypoints: Partial<TokenMovementWaypoint>[], options?: TokenFindMovementPathOptions | undefined): TokenFindMovementPathJob;
    /**
     ...
     * @param {Partial<Omit<TokenProcessedMovementWaypoint, "terrain">>[]} waypoints  The waypoints of movement
     * @param {TokenCreateTerrainMovementPathOptions} [options]                       Additional options
     * @returns {TokenProcessedMovementWaypoint[]}                                    The movement path with terrain data
     */
    createTerrainMovementPath(waypoints: Partial<Omit<TokenProcessedMovementWaypoint, "terrain">>[], options?: TokenCreateTerrainMovementPathOptions | undefined): TokenProcessedMovementWaypoint[];
    /**
     ...
     * @param {TokenPanningOptions} [options]    Additional options
     * @returns {Promise<void>}  Resolves once the panning/transition animation is complete.
     */
    panCanvas({ transitionType, duration, speed, easing, force }?: TokenPanningOptions | undefined): Promise<void>;
    /**
     ...
     * @param {boolean|TokenPanningOptions} [options.pan=false] Pan to the controlled Token
     * @protected
     * @inheritDoc
     */
    protected _onControl({ releaseOthers, pan, ...options }?: {
        releaseOthers?: boolean | undefined;
     ...
     * @protected
     */
    protected _getDragTerrainOptions(): Omit<TokenCreateTerrainMovementPathOptions, "preview">;
    /**
     ...
     * @protected
     */
    protected _getDragConstrainOptions(): Omit<TokenConstrainMovementPathOptions, "preview" | "history" | "measureOptions">;
    /**
     ...
     * @protected
     */
    protected _getDragMeasureOptions(): Omit<TokenMeasureMovementPathOptions, "preview">;
    /**
     * Get the pathfinding options used during the drag operation to find the path of movement through the waypoints.
     * @returns {Omit<TokenFindMovementPathOptions, "preview"|"terrainOptions"|"constrainOptions"|
     *   "measureOptions">} The pathfinding options
     * @protected
     */
    protected _getDragPathfindingOptions(): Omit<TokenFindMovementPathOptions, "preview" | "terrainOptions" | "constrainOptions" | "measureOptions">;
    /**
     ...
     * @protected
     */
    protected _getDragLeftDropUpdateOptions(): Partial<Omit<DatabaseUpdateOperation, "updates"> & Omit<TokenMovementOptions, "id" | "method">>;
    /** @override */
    override _prepareDragLeftDropUpdates(event: any): ({
         ...
         */
        parent?: foundry.abstract.Document<object, foundry.abstract.types.DocumentConstructionContext> | null | undefined;
        /**
        ...
        animation?: {
             ...
             */
            easing?: foundry.canvas.animation.types.CanvasAnimationEasingFunction | undefined;
        } | undefined;
        /**
     ...
     * @param {DeepReadonly<Omit<TokenCoordinates, "level">>} current
     * @param {DeepReadonly<Partial<ElevatedPoint>>} changes
     * @param {object} [options]
     * @param {boolean} [options.snap=false]
     * @returns {Omit<TokenCoordinates, "level"> & Partial<TokenDimensions>}
     * @internal
     */
    _getDragWaypointPosition(current: DeepReadonly<Omit<TokenCoordinates, "level">>, changes: DeepReadonly<Partial<ElevatedPoint>>, { snap }?: {
        snap?: boolean | undefined;
    } | undefined): Omit<TokenCoordinates, "level"> & Partial<TokenDimensions>;
    /**
...
import type { TokenMeasurableMovementWaypoint } from "../../documents/_types.mjs";
...
import type { TokenProcessedMovementWaypoint } from "../../documents/_types.mjs";
...
import type { TokenCoordinates } from "../../../common/documents/_types.mjs";
