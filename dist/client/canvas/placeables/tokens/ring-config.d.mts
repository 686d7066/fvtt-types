...
export default class TokenRingConfig {
     ...
     */
    static "__#191@#instance": TokenRingConfig;
    /**
     * To know if the ring config is initialized.
     * @type {boolean}
     */
    static "__#191@#initialized": boolean;
    /**
     * To know if a Token Ring registration is possible.
     * @type {boolean}
     */
    static "__#191@#closedRegistration": boolean;
    /**
