...
export default class TokenRing {
    ...
    static "__#189@#initialized": null;
    /**
     ...
     * @type {RingData[]}
     */
    static "__#189@#ringData": RingData[];
    /**
     * Default ring thickness in normalized space.
     * @type {number}
     */
    static "__#189@#defaultRingThickness": number;
    /**
     * Default ring subject thickness in normalized space.
     * @type {number}
     */
    static "__#189@#defaultSubjectThickness": number;
    /**
     ...
     */
    static getTextureUVs(name: string, scaleCorrection?: number | undefined): Float32Array | void;
    /**
     ...
     */
    static createSpikeEasing(spikePct?: number | undefined): Function;
    /**
