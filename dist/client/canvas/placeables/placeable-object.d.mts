 ...
 * @import {TokenPanningOptions} from "../../_types.mjs";
 */
/**
...
export default class PlaceableObject extends PlaceableObject_base {
     ...
     * @type {"dragging"|"controls"|"wheel"|"creation"|"config"|"api"|null}
     * @internal
     */
     ...
     * @param {boolean} [options.cut=false]       Is cut operation?
     * @returns {object}                          The create or update data
     * @internal
     */
     ...
     * This function is called in {@link PlaceableObject#draw} before the {@link PlaceableObject#_draw} call.
     * @protected
     */
     ...
     * @param {boolean} [options.releaseOthers=true]    Release any other controlled objects first. Default: `true`.
     * @param {boolean} [options.renderSidebar=true]    Re-render the sidebar. Default: `true`.
     * @param {boolean} [options.isNew=false]           Was this object just created? Default: `false`.
     * @param {boolean} [options.force=false]           Control the object even if it is not interactable? Default: `false`.
     * @param {boolean|TokenPanningOptions} [options.pan=false]  Pan to this Token? Only applies to Token. Default: `false`.
     * @param {boolean} [options.chain=false]           Control all Walls that are linked with this Wall. Only applies to Wall. Default: `false`.
     ...
     * @param {boolean} [options.renderSidebar]  Re-render the sidebar.
     ...
     * @protected
     */
    protected _createInteractionManager(): MouseInteractionManager | null;
    /**
     ...
     * @param {User} user                          The User performing the action. Always equal to `game.user`.
     * @param {PIXI.FederatedEvent|Event} [event]  The DOM interaction event or pointer event if this function was
     *                                             called by {@link foundry.canvas.interaction.MouseInteractionManager}.
     * @returns {boolean}
     * @protected
     */
    protected _canHover(user: User, event?: PIXI.FederatedEvent | Event): boolean;
    /**
     ...
     * @param {PIXI.FederatedEvent|Event} event          The triggering canvas or DOM interaction event
     ...
     * @param {boolean} [options.updateLegend=true]      Highlight corresponding entry in the sidebar legend.
     * @returns {boolean|void}
     * @protected
     */
    protected _onHoverIn(event: PIXI.FederatedEvent | Event, { hoverOutOthers, updateLegend }?: {
     ...
     * @protected
     */
    protected _onHoverOut(event: PIXI.FederatedEvent | Event, { updateLegend }?: {
        updateLegend?: boolean | undefined;
    } | undefined): void;
    /**
