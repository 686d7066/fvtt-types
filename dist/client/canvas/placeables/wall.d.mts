/**
 * @import DoorControl from "../containers/elements/door-control.mjs";
...
export default class Wall extends PlaceableObject {
     ...
     * @returns {number}
     */
    static "__#177@#getLineWidth"(): number;
     ...
     * @returns {DoorControl|null}
     */
    createDoorControl(): DoorControl | null;
    /**
    ...
    /** @override */
    override _onClickLeft(event: any): false | undefined;
    /** @override */
...
import type DoorControl from "../containers/elements/door-control.mjs";
import DoorMesh from "../containers/elements/door-mesh.mjs";
import type Edge from "../geometry/edges/edge.mjs";
