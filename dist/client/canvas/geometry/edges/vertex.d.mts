...
export default class PolygonVertex {
     ...
     * @type {number}
     */
    static "__#63@#MAX_TEXTURE_SIZE": number;
    /**
     ...
     */
    static fromPoint(point: Point, options?: PolygonVertexOptions | undefined): PolygonVertex;
    /**
     ...
     */
    constructor(x: number, y: number, { distance, index, round }?: PolygonVertexOptions | undefined);
    x: number;
    y: number;
    key: number;
    /**
