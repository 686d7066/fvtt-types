/**
 * @import {ClockwiseSweepEdgeConfig, EdgeType, VertexMap} from "./_types.mjs"
 ...
 * @extends {PointSourcePolygon<ClockwiseSweepPolygonConfig>}
 */
export default class ClockwiseSweepPolygon extends PointSourcePolygon<ClockwiseSweepPolygonConfig> {
     ...
     * @protected
     */
    protected _determineEdgeTypes(type: string, priority: number, config?: object | undefined): Record<EdgeType, ClockwiseSweepEdgeConfig>;
    /**
     ...
     * @param {Record<EdgeType, ClockwiseSweepEdgeConfig>} edgeTypes Which types of edges are being used?
     * @returns {boolean}    Should the edge be included?
     * @protected
     */
    protected _testEdgeInclusion(edge: Edge, edgeTypes: Record<EdgeType, ClockwiseSweepEdgeConfig>): boolean;
    /**
    ...
    /** @override */
    override _testCollision(ray: any, mode: any, destination: any, tMin: any, tMax: any): any;
    /**
...
import type { ClockwiseSweepPolygonConfig } from "./_types.mjs";
...
import type { ClockwiseSweepEdgeConfig } from "./_types.mjs";
import type Edge from "./edges/edge.mjs";
