/**
 * @import {BaseEffectSourceData, BaseEffectSourceOptions} from "./_types.mjs";
...
export default class BaseEffectSource<TSourceData extends BaseEffectSourceData = BaseEffectSourceData, TSourceShape extends PIXI.Polygon = PIXI.Polygon> {
     ...
     */
    constructor(options?: BaseEffectSourceOptions | undefined);
    /**
     ...
     */
    get effectsCollection(): Collection<string, BaseEffectSource<BaseEffectSourceData, PIXI.Polygon>>;
    /**
     ...
     * @returns {this}                          The initialized source
     */
     ...
     * @protected
     */
    protected _initialize(data: Partial<TSourceData>): void;
    /**
...
import type { BaseEffectSourceData } from "./_types.mjs";
...
import type { BaseEffectSourceOptions } from "./_types.mjs";
