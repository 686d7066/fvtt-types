...
export default class ImageHelper {
     ...
     * @param {string} [options.format]       The desired output image format. Default: `"image/webp"`.
     * @param {number} [options.quality]      The desired output image quality. Default: `0.8`.
     * @returns {Promise<{thumb: string; width: number; height: number; format: string; quality: number}|null>}
     ...
     */
    static canvasToBase64(canvas: HTMLCanvasElement, type?: string | undefined, quality?: number | undefined): Promise<string>;
    /**
