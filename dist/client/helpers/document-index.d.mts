/**
 * @import WordTree from "../../common/utils/string-tree.mjs";
...
export default class DocumentIndex {
    /**
     * A unicode-friendly regular-expression pattern matching all non-word characters in a string
     * @type {RegExp}
     */
    static "__#383@#NON_WORD_CHARACTERS_PATTERN": RegExp;
    /**
     ...
     * @returns {boolean}
     */
    static "__#383@#filterEntryForOwnership"({ uuid, pack }: WordTreeEntry, ownership: DOCUMENT_OWNERSHIP_LEVELS | string): boolean;
    /**
     ...
     */
    uuids: Record<string, StringTreeNode[]>;
    /**
     ...
     *                                            type.
     */
    lookup(query: string, { limit, documentTypes, ownership, filterEntries }?: {
    ...
    } | undefined): Record<string, WordTreeEntry[]>;
    /**
     ...
     * @param {object} doc                           The Document or compendium index entry to add.
     ...
     * @protected
     */
    protected _addLeaves(doc: object, { pack }?: {
        pack?: any;
    } | undefined): void;
    /**
     ...
     * @ignore
     */
    protected _addLeaf(doc: any, options: any): void;
    /**
...
import type WordTree from "../../common/utils/string-tree.mjs";
import type { StringTreeNode } from "../../common/utils/_types.mjs";
