/**
 * @import CalendarData from "../data/calendar.mjs";
 * @import {CalendarConfig, TimeComponents, TimeFormatter} from "../data/_types.mjs";
 */
/**
...
export default class GameTime {
     ...
     * @type {number}
     */
    static "__#384@#PING_HISTORY_LENGTH": number;
    /**
     * The calendar instance for in-world timekeeping.
     * @type {CalendarData}
     */
    get calendar(): CalendarData<TimeComponents>;
    /**
     * The "Earth" calendar instance for IRL timekeeping.
     * @type {CalendarData}
     */
    get earthCalendar(): CalendarData<TimeComponents>;
    /**
     ...
     */
    advance(delta: TimeComponents | number, options?: object | undefined): Promise<number>;
    /**
     ...
     * @returns {Promise<number>}               The new game time
     */
    set(time: TimeComponents | number, options?: object | undefined): Promise<number>;
    /**
     ...
     */
    onUpdateWorldTime(worldTime: number, options: object, userId: string): Promise<void>;
    #private;
}
import type { TimeComponents } from "../data/_types.mjs";
import type CalendarData from "../data/calendar.mjs";
