...
export default class Localization {
     ...
     */
    static "__#385@#localizeDataModels"(): void;
    /**
     ...
     * @param {Record<string, unknown>} [data] Data for variable formating: values can be anything meaningfully
     *                                         stringifiable.
     * @returns {string}                       The translated string, if a translation was found, or else the inputted
     *                                         stringId
     *
     ...
     */
    localize(stringId: string, data?: Record<string, unknown> | undefined): string;
    /**
