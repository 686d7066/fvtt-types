...
export default class CombatConfiguration {
     ...
     */
    static "__#262@#instance": CombatConfiguration;
    /**
     * To know if the ring config is initialized.
     * @type {boolean}
     */
    static "__#262@#initialized": boolean;
    /**
     * Combat turn marker animation configurations
     * @type {Record<string, TurnMarkerAnimationData>}
     */
    static "__#262@#DEFAULT_TURN_MARKER_ANIMATIONS": Record<string, TurnMarkerAnimationData>;
    /**
     ...
     */
    static "__#262@#onChangeCombatConfiguration"(): void;
    /**
