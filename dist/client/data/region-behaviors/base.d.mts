/**
 * @import {Point, ElevatedPoint, TokenMovementWaypoint, TokenCreateTerrainMovementPathOptions} from "../../_types.mjs";
 * @import {RegionDocument, RegionBehavior, Scene} from "../../documents/_module.mjs";
 * @import {RegionEvent} from "../../documents/_types.mjs";
...
export default class RegionBehaviorType extends TypeDataModel<object> {
     ...
     * @param {Pick<TokenMovementWaypoint, "width"|"height"|"shape"|"level"|"action"> & {preview: boolean}} segment
     *                                 The segment data of the token's movement
     * @param {Omit<TokenCreateTerrainMovementPathOptions, "preview">} [options]    Additional options
     * @returns {TerrainEffect[]}      The terrain effects that apply to this token's movement
     * @protected
     */
    protected _getTerrainEffects<TerrainEffect>(token: TokenDocument, segment: Pick<TokenMovementWaypoint, "width" | "height" | "shape" | "level" | "action"> & {
        preview: boolean;
    }, options?: Omit<TokenCreateTerrainMovementPathOptions, "preview"> | undefined): TerrainEffect[];
}
...
import type { RegionEvent } from "../../documents/_types.mjs";
