...
export default class ModifyMovementCostRegionBehaviorType extends RegionBehaviorType {
     ...
     */
    static "__#257@#onBehaviorViewed"(this: ModifyMovementCostRegionBehaviorType, event: RegionBehaviorViewedEvent): Promise<void>;
    /**
     * Called when the darkness behavior is unviewed.
     * @param {RegionBehaviorUnviewedEvent} event
     * @this {ModifyMovementCostRegionBehaviorType}
     */
    static "__#257@#onBehaviorUnviewed"(this: ModifyMovementCostRegionBehaviorType, event: RegionBehaviorUnviewedEvent): Promise<void>;
    /**
     * Called when the boundary of an event has changed.
     * @param {RegionRegionBoundryEvent} event
     * @this {ModifyMovementCostRegionBehaviorType}
     */
    static "__#257@#onRegionBoundary"(this: ModifyMovementCostRegionBehaviorType, event: RegionRegionBoundryEvent): Promise<void>;
    /** @override */
    ...
    /** @override */
    override _getTerrainEffects(token: any, segment: any, options: any): {
        name: string;
        difficulty: any;
    }[];
}
