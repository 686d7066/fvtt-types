...
export default class ClientDatabaseBackend extends DatabaseBackend {
     ...
     * @param {User} user
     */
    static "__#264@#preCreateDocumentArray"(documentClass: typeof ClientDocument, operation: DatabaseCreateOperation, user: User): Promise<void>;
    /**
     ...
     * @param {User} user
     */
    static "__#264@#preUpdateDocumentArray"(documentClass: typeof ClientDocument, operation: DatabaseUpdateOperation, user: User): Promise<void>;
    /**
     ...
     * @param {User} user
     */
    static "__#264@#preDeleteDocumentArray"(documentClass: typeof ClientDocument, operation: DatabaseDeleteOperation, user: User): Promise<void>;
    /**
     ...
     */
    static "__#264@#getCollection"(documentClass: typeof ClientDocument, { parent, pack }: {
     ...
     */
    static "__#264@#buildRequest"(documentClass: typeof ClientDocument, action: DatabaseAction, operation: DatabaseOperation): DocumentSocketRequest;
    /**
     * Dispatch a document modification socket request to the server, immediately returning null if a dry run.
     * @param {DocumentSocketRequest} request
     * @returns {DocumentSocketResponse|DocumentSocketResponse[]} A single response for "get" actions, otherwise
     *   an array of responses (primary response with side effects)
     */
    static "__#264@#dispatchRequest"(request: DocumentSocketRequest): DocumentSocketResponse | DocumentSocketResponse[];
    /**
     ...
     */
    static "__#264@#loadCompendiumDocuments"(collection: Collection<any, any>, documents: object[] | string[]): Promise<void>;
    /**
     ...
     */
    static "__#264@#adjustActorDeltaRequest"(documentClass: typeof ClientDocument, request: DocumentSocketRequest): void;
    /**
     ...
     */
    static "__#264@#getTokenAncestor"(parent: ClientDocument | null): TokenDocument | null;
    /**
     ...
     */
    static "__#264@#adjustActorDeltaResponse"(documents: ActorDelta[]): ClientDocument[];
    /**
     * @override
     * @ignore
     */
     ...
     * @ignore
     */
    override _updateDocuments(documentClass: any, operation: any, user: any): Promise<any[]>;
    /**
     * @override
     * @ignore
     */
     ...
     * @see {@link foundry.documents.modifyBatch}
     * @param {DatabaseWriteOperation[]} operations
     * @returns {Promise<ClientDocument[][]>}
     */
    modifyDocumentBatch(operations: DatabaseWriteOperation[]): Promise<ClientDocument[][]>;
    /**
     * Activate the Socket event listeners used to receive responses from events which modify database documents
     * @param {io.Socket} socket                           The active game socket
     * @internal
     */
    _activateSocketListeners(socket: io.Socket): void;
    /** @inheritDoc */
    getFlagScopes(): any[];
    /** @override */
