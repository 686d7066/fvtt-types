/**
 * @import {TokenCreateTerrainMovementPathOptions, TokenMeasureMovementPathOptions,
 *   TokenMovementCostFunction} from "../_types.mjs";
...
export class BaseTerrainData<TerrainEffect> extends DataModel<object, foundry.abstract.types.DataModelConstructionContext> {
     ...
     * @abstract
     */
    static resolveTerrainEffects(effects: TerrainEffect[], options?: Omit<TokenCreateTerrainMovementPathOptions, "preview"> | undefined): BaseTerrainData<TerrainEffect> | null;
    /**
     ...
     * @abstract
     */
    static getMovementCostFunction(token: TokenDocument, options?: TokenMeasureMovementPathOptions | undefined): TokenMovementCostFunction | void;
...
export class TerrainData extends BaseTerrainData<{
    ...
    /** @override */
    static override resolveTerrainEffects(effects: any, options: any): TerrainData | null;
    /** @override */
