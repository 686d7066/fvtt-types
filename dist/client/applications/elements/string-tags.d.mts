...
export default class HTMLStringTagsElement extends AbstractFormInputElement<Set<string>> {
     ...
     */
    static renderTag(tag: string, label?: string | undefined, editable?: boolean | undefined): HTMLDivElement;
    /**
     ...
     */
    constructor({ slug, values }?: HTMLStringTagsOptions | undefined);
    /** @override */
     ...
     * @protected
     */
    protected _initializeTags(values?: string[] | undefined): void;
    /**
