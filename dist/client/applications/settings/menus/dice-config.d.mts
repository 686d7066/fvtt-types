 ...
 */
export default class DiceConfig extends DiceConfig_base {
    /** @inheritDoc */
    ...
    static "__#300@#onSubmit"(event: SubmitEvent | Event, form: HTMLFormElement, formData: foundry.applications.ux.FormDataExtended): Promise<any>;
    /** @override */
