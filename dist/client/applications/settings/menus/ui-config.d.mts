 ...
 */
export default class UIConfig extends UIConfig_base {
    /** @inheritDoc */
    ...
    static "__#302@#schema": fields.SchemaField;
    /**
     * Track whether the schema has already been localized.
     * @type {boolean}
     */
    static "__#302@#localized": boolean;
    /**
     ...
     */
    static "__#302@#cleanFormData"(formData: FormDataExtended): GameUIConfiguration;
    /**
     ...
     */
    static "__#302@#onSubmit"(this: UIConfig, event: SubmitEvent, form: HTMLFormElement, formData: FormDataExtended): Promise<void>;
    /**
     ...
     * @returns {Promise<void>}
     */
    static "__#302@#onReset"(this: UIConfig, event: InputEvent): Promise<void>;
    /** @inheritDoc */
    ...
    /** @override */
    override _onChangeForm(_formConfig: any, _event: any): void;
    #private;
}
export type GameUIConfiguration = {
    uiScale: number;
    fontScale: number;
    colorScheme: {
