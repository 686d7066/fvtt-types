...
export default class DependencyResolution extends ApplicationV2<any, HandlebarsRenderOptions> {
     ...
     */
    static "__#295@#onCancel"(this: DependencyResolution): Promise<DependencyResolution>;
    /**
     ...
     */
    static "__#295@#onSubmitForm"(this: DependencyResolution, event: SubmitEvent, form: HTMLFormElement): void;
    /**
