...
export default class SettingsConfig extends CategoryBrowser {
    ...
    static "__#165@#onOpenSubmenu"(event: PointerEvent, target: HTMLElement): void | Promise<void>;
    static "__#165@#onResetDefaults"(event: PointerEvent, target: HTMLElement): void | Promise<void>;
    static "__#165@#onSubmit"(event: SubmitEvent | Event, form: HTMLFormElement, formData: foundry.applications.ux.FormDataExtended): Promise<any>;
    /** @inheritDoc */
