 ...
 */
export function getTemplate(path: string, id?: string | undefined): Promise<Handlebars.TemplateDelegate>;
/**
 ...
 * @param {string} [options.engine="prosemirror"]  The editor engine to use, see
 *   {@link foundry.applications.ux.TextEditor.create}. Default: `"prosemirror"`.
...
} | undefined): Handlebars.SafeString;
/**
