 ...
 * @property {"target"|"cursor"} [relative="cursor"]  For fixed context menus, control whether the menu is positioned
 ...
 *                                              instances.
 * @property {boolean} [closeOnSelect=true]     Close the context menu when one of the options is selected.
 */
/**
...
export default class ContextMenu {
     ...
     */
    static activateListeners(document: Document, { _deprecated }?: {
     ...
     */
    constructor(container: HTMLElement | jQuery, selector: string, menuItems: ContextMenuEntry[], { eventName, onOpen, onClose, jQuery, fixed, relative, closeOnSelect }?: ContextMenuOptions | undefined);
    /**
     ...
     * @protected
     */
    protected _preRender(target: HTMLElement, options?: ContextMenuRenderOptions | undefined): Promise<void>;
    /**
     ...
     * @protected
     */
    protected _preRenderEntries(options?: ContextMenuRenderOptions | undefined): Promise<void>;
    /**
     ...
     */
    render(target: HTMLElement, options?: ContextMenuRenderOptions | undefined): Promise<void>;
    /**
     ...
     * @protected
     */
    protected _onRender(options?: ContextMenuRenderOptions | undefined): Promise<void>;
    /**
     * Called after the context menu has finished rendering its entries.
     * @param {HTMLMenuElement} menu  The rendered menu.
     * @param {ContextMenuRenderOptions} [options]
     * @returns {Promise<void>}
     * @protected
     */
    protected _onRenderEntries(menu: HTMLMenuElement, options?: ContextMenuRenderOptions | undefined): Promise<void>;
    /**
     ...
     * @param {ContextMenuRenderOptions} [options]
     */
    activateListeners(menu: HTMLElement, options?: ContextMenuRenderOptions | undefined): void;
    /**
...
export type ContextMenuEntry = {
     ...
     */
    onClick?: ContextMenuCallback | undefined;
    /**
     * A function to call or boolean value to determine if this entry
     *    appears in the menu.
     */
    visible?: boolean | ContextMenuCondition | undefined;
};
export type ContextMenuCondition = (target: HTMLElement) => boolean;
export type ContextMenuCallback = (event: PointerEvent, target: HTMLElement) => unknown;
export type ContextMenuJQueryCallback = (target: HTMLElement | jQuery, event: PointerEvent) => unknown;
