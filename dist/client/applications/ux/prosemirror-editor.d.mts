...
export default class ProseMirrorEditor {
     ...
     */
    static "__#11@#editors": Map<string, ProseMirrorEditor>;
    /**
     ...
     */
    static create(target: HTMLElement, content?: string | undefined, { uuid, document, fieldName, plugins, collaborate, relativeLinks, props }?: {
    ...
    } | undefined): Promise<ProseMirrorEditor>;
    /**
     ...
     * @param {boolean} [options.collaborate]      Whether this is a collaborative editor.
     */
    constructor(uuid: string, view: EditorView, options?: {
        document?: any;
        collaborate?: boolean | undefined;
    } | undefined, _collaborate: any, _options?: {});
    options: {
        document?: any;
        collaborate?: boolean | undefined;
    };
