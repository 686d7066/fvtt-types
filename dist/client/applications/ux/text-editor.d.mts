...
export default class TextEditor {
     ...
     */
    static "__#229@#decoder": HTMLTextAreaElement;
    /**
     ...
     * @param {string} [options.engine=prosemirror]  Which rich text editor engine to use.
     * @param {string} content                       Initial HTML or text content to populate the editor with
     * @returns {ProseMirrorEditor}                  The editor instance.
     */
    static create({ engine, ...options }?: {
        engine?: string | undefined;
    }, content?: string): ProseMirrorEditor;
    /**
     * A list of elements that are retained when truncating HTML.
     * @type {Set<string>}
     */
    static "__#229@#PARAGRAPH_ELEMENTS": Set<string>;
    /**
     ...
     */
    static enrichHTML(content: string, options?: EnrichmentOptions | undefined): Promise<string>;
    /**
     ...
     * @protected
     */
    protected static _primeCompendiums(text: Text[], options?: EnrichmentOptions | undefined): Promise<void>;
    /**
     ...
     * @protected
     */
    protected static _enrichContentLinks(text: Text[], options?: EnrichmentOptions | undefined): Promise<boolean>;
    /**
     ...
     * @protected
     */
    protected static _enrichEmbeds(text: Text[], options?: EnrichmentOptions | undefined): Promise<boolean>;
    /**
     ...
     * @protected
     */
    protected static _enrichHyperlinks(text: Text[], options?: EnrichmentOptions | undefined): Promise<boolean>;
    /**
     ...
     * @protected
     */
    protected static _enrichInlineRolls(rollData: object | Function, text: Text[], options?: EnrichmentOptions | undefined): Promise<boolean>;
    /**
     ...
     * @protected
     */
    protected static _applyCustomEnrichers({ id, pattern, enricher, onRender, replaceParent }: TextEditorEnricherConfig, text: Text[], options?: EnrichmentOptions | undefined): Promise<boolean>;
    /**
     ...
     */
    static "__#229@#wrapSecrets"(html: HTMLDivElement): void;
    /**
     ...
     */
    static "__#229@#getTextNodes"(parent: HTMLElement): Text[];
    /**
     ...
     * @protected
     */
    protected static _replaceTextContent(text: Text[], rgx: RegExp, func: TextContentReplacer, options?: TextReplacementOptions | undefined): boolean;
    /**
     ...
     * @param {TextReplacementOptions} [options]  Options to configure text replacement behavior.
     */
    static "__#229@#replaceTextNode"(text: Text, match: RegExpMatchArray, replacement: Node, { replaceParent }?: TextReplacementOptions | undefined): void;
    /**
     ...
     * @protected
     */
    protected static _createContentLink(match: RegExpMatchArray, { relativeTo }?: EnrichmentOptions | undefined): Promise<HTMLAnchorElement>;
    /**
     ...
     */
    static createAnchor({ attrs, dataset, classes, name, icon }?: Partial<EnrichmentAnchorOptions> | undefined): HTMLAnchorElement;
    /**
     ...
     * @protected
     */
    protected static _embedContent(match: RegExpMatchArray, options?: EnrichmentOptions | undefined): Promise<HTMLElement | null>;
    /**
     ...
     * ```
     */
    protected static _parseEmbedConfig(raw: string, options?: object | undefined): DocumentHTMLEmbedConfig;
    /**
     ...
     */
    static "__#229@#createLegacyContentLink"(type: string, target: string, name: string, data: object): boolean;
    /**
     ...
     * @protected
     */
    protected static _createHyperlink(match: RegExpMatchArray, options?: EnrichmentOptions | undefined): Promise<HTMLAnchorElement>;
    /**
     ...
     * @protected
     */
    protected static _createInlineRoll(match: RegExpMatchArray, rollData: object, options?: EnrichmentOptions | undefined): Promise<HTMLAnchorElement | null>;
    /**
     * Activate interaction listeners for the interior content of the editor frame.
     * @param {Document} document  The document to bind listeners to.
     */
     ...
     * @param {Event} event
     */
    static "__#229@#onClickContentLink"(event: Event): Promise<any>;
    /**
     ...
     */
    static "__#229@#onDragContentLink"(event: Event): false | undefined;
    /**
