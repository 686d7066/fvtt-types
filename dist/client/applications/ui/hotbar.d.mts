...
export default class Hotbar extends ApplicationV2<foundry.applications.types.ApplicationConfiguration, foundry.applications.types.ApplicationRenderOptions> {
     ...
     * @returns {Promise<void>}
     */
    static "__#356@#onExecute"(this: Hotbar, event: PointerEvent): Promise<void>;
    /**
     * Handle click events to toggle the hotbar locked state.
     * @this {Hotbar}
     * @returns {Promise<void>}
     */
    static "__#356@#onToggleLock"(this: Hotbar): Promise<void>;
    /**
     * Handle click events to toggle the global mute state.
     * @this {Hotbar}
     * @returns {Promise<void>}
     */
    static "__#356@#onToggleMute"(this: Hotbar): Promise<void>;
    /**
     * Handle click events to toggle the game main menu.
     * @this {Hotbar}
     * @returns {Promise<void>}
     */
    static "__#356@#onToggleMenu"(this: Hotbar): Promise<void>;
    /**
     * Handle click events to toggle the game main menu.
     * @this {Hotbar}
     * @returns {Promise<void>}
     */
    static "__#356@#onClear"(this: Hotbar): Promise<void>;
    /**
     ...
     * @returns {Promise<void>}
     */
    static "__#356@#onPage"(this: Hotbar, event: PointerEvent): Promise<void>;
