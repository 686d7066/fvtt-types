 ...
 * @property {boolean} [interaction]  Does this tool allow interaction with placeables?
 * @property {boolean} [control]      Does this tool allow placeables to be controlled?
 * @property {boolean} [creation]     Does this tool create placeables?
 * @property {object} [createData]  Default creation data
 * @property {object} [shapeData]   The data of the shape this tool creates
 ...
 * @property {(event: Event, tool: SceneControlTool, active: boolean) => void} [onToolChange]
...
export default class SceneControls extends ApplicationV2<ApplicationConfiguration, SceneControlsRenderOptions> {
    ...
    /** @inheritDoc */
    static emittedEvents: readonly ["prerender", "render", "close", "position", "activate"];
    /**
     ...
     */
    static "__#47@#onChangeControl"(this: SceneControls, event: PointerEvent): void;
    /**
     * Handle changing the active tool within the currently active control set.
     * @this {SceneControls}
     * @param {PointerEvent} event
     */
    static "__#47@#onChangeTool"(this: SceneControls, event: PointerEvent): void;
     ...
     * @param {boolean} [toggle]  Whether to toggle it on or off.
     * @returns {Promise<void>}
     */
    togglePlaceablePalette(toggle?: boolean | undefined): Promise<void>;
    /**
...
export type SceneControl = {
     ...
     */
    visible?: boolean | undefined;
    tools?: Record<string, SceneControlTool> | undefined;
     ...
     * A callback invoked when a tool is activated or deactivated
     */
    onToolChange?: ((event: Event, tool: SceneControlTool, active: boolean) => void) | undefined;
};
