...
export default class DocumentDirectory<TDocument extends ClientDocument = ClientDocument> extends AbstractSidebarTab<DocumentDirectoryConfiguration, HandlebarsRenderOptions> {
     ...
     */
    static "__#82@#onClickEntry"(this: DocumentDirectory<ClientDocument>, ...args: any[]): Promise<void>;
    /**
     * Collapse open folders in this directory.
     * @this {DocumentDirectory}
     */
    static "__#82@#onCollapseFolders"(this: DocumentDirectory<ClientDocument>): void;
    /**
     * Handle creating a new entry in this directory.
     * @this {DocumentDirectory}
     * @param {...any} args
     */
    static "__#82@#onCreateEntry"(this: DocumentDirectory<ClientDocument>, ...args: any[]): any;
    /**
     * Handle creating a new folder in this directory.
     * @this {DocumentDirectory}
     * @param {...any} args
     */
    static "__#82@#onCreateFolder"(this: DocumentDirectory<ClientDocument>, ...args: any[]): void;
    /**
     * Handle showing the client issues dialog.
     * @this {DocumentDirectory}
     */
    static "__#82@#onShowIssues"(this: DocumentDirectory<ClientDocument>): void;
    /**
     * Handle toggling a folder's expanded state.
     * @this {DocumentDirectory}
     * @param {...any} args
     */
    static "__#82@#onToggleFolder"(this: DocumentDirectory<ClientDocument>, ...args: any[]): any;
    /**
     * Handle toggling the search mode.
     * @this {DocumentDirectory}
     */
    static "__#82@#onToggleSearch"(this: DocumentDirectory<ClientDocument>): void;
    /**
     * Handle toggling the sort mode.
     * @this {DocumentDirectory}
     */
    static "__#82@#onToggleSort"(this: DocumentDirectory<ClientDocument>): void;
    /**
     ...
     * @protected
     */
    protected _onMatchSearchEntry(query: string, entryIds: Set<string>, element: HTMLElement, options?: object | undefined): void;
    /**
     ...
     * @protected
     */
    protected _matchSearchEntries(query: RegExp, entryIds: Set<string>, folderIds: Set<string>, autoExpandIds: Set<string>, options?: object | undefined): void;
    /**
     ...
     * @protected
     */
    protected _matchSearchFolders(query: RegExp, folderIds: Set<string>, autoExpandIds: Set<string>, options?: object | undefined): void;
    /**
     ...
     * @protected
     */
    protected _createDroppedEntry(entry: DirectoryMixinEntry, updates?: object | undefined): Promise<TDocument>;
    /**
     ...
     * @protected
     */
    protected _createDroppedFolderContent(folder: Folder, targetFolder?: Folder | undefined): Promise<Folder[]>;
    /**
     ...
     * @protected
     */
    protected _organizeDroppedFoldersAndDocuments(folder: Folder, targetFolder?: Folder | undefined): Promise<{
