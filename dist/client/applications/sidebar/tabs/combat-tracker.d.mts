...
export default class CombatTracker extends AbstractSidebarTab<foundry.applications.types.ApplicationConfiguration, foundry.applications.types.ApplicationRenderOptions> {
    ...
    static DEFAULT_OPTIONS: {
        ...
        actions: {
            activateCombatant: Function;
            cycleCombat: Function;
            createCombat: Function;
            editName: Function;
            panToCombatant: Function;
            pingCombatant: Function;
            rollInitiative: Function;
            toggleDefeated: Function;
            toggleHidden: Function;
            trackerSettings: Function;
        };
    };
    /** @override */
     ...
     * @param {...any} args
     */
    static "__#346@#onCombatCycle"(this: CombatTracker, ...args: any[]): Promise<Combat>;
    /**
     * Create a new combat.
     * @this {CombatTracker}
     * @param {...any} args
     ...
     */
    static "__#346@#onCombatCreate"(this: CombatTracker, ...args: any[]): Promise<void>;
    /**
     ...
     */
    static "__#346@#onConfigure"(this: CombatTracker, event: PointerEvent, target: HTMLElement): Promise<foundry.applications.apps.CombatTrackerConfig>;
    /**
     * Open the dialog used to edit the name of the currently viewed Combat encounter.
     * @this {CombatTracker}
     * @returns {Promise<void>}
     */
    static "__#346@#onEditName"(this: CombatTracker): Promise<void>;
    /**
     * Handle performing some action for an individual combatant.
     * @this {CombatTracker}
     * @param {...any} args
     */
    static "__#346@#onCombatantControl"(this: CombatTracker, ...args: any[]): any;
    /**
     * Handle activating a combatant in the tracker.
     * @this {CombatTracker}
     * @param {...any} args
     */
    static "__#346@#onCombatantMouseDown"(this: CombatTracker, ...args: any[]): void;
...
import Combat from "../../../documents/combat.mjs";
