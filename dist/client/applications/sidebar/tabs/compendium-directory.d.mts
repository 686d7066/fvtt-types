...
export default class CompendiumDirectory extends AbstractSidebarTab<ApplicationConfiguration, HandlebarsRenderOptions> {
     ...
     */
    static "__#347@#onCollapseFolders"(this: CompendiumDirectory): void;
    /**
     * Handle clicking on a compendium entry.
     * @this {CompendiumDirectory}
     * @param {...any} args
     */
    static "__#347@#onClickEntry"(this: CompendiumDirectory, ...args: any[]): void;
    static "__#347@#onOpenDocumentSheet"(event: PointerEvent, target: HTMLElement): void | Promise<void>;
    /**
     * Handle creating a new compendium pack.
     * @this {CompendiumDirectory}
     * @param {...any} args
     */
    static "__#347@#onCreateEntry"(this: CompendiumDirectory, ...args: any[]): Promise<void>;
    /**
     * Handle creating a new folder in this directory.
     * @this {CompendiumDirectory}
     * @param {...any} args
     */
    static "__#347@#onCreateFolder"(this: CompendiumDirectory, ...args: any[]): void;
    /**
     * Handle toggling a folder's expanded state.
     * @this {CompendiumDirectory}
     * @param {...any} args
     */
    static "__#347@#onToggleFolder"(this: CompendiumDirectory, ...args: any[]): void;
    /**
     * Handle toggling the sort mode.
     * @this {CompendiumDirectory}
     */
    static "__#347@#onToggleSort"(this: CompendiumDirectory): Promise<CompendiumDirectory>;
     ...
     * @protected
     */
    protected _onToggleCompendiumFilterType(event: PointerEvent, type?: string | undefined): Promise<this>;
    /**
     * Handle toggling a folder's expanded state.
     * @param {PointerEvent} event  The triggering click event.
     * @param {HTMLElement} target  The action target element.
     ...
     * @protected
     */
    protected _onMatchSearchEntry(query: string, packs: Set<string>, element: HTMLElement, options?: object | undefined): void;
    /**
     ...
     * @protected
     */
    protected _matchSearchCompendiums(query: RegExp, packs: Set<string>, folderIds: Set<string>, autoExpandIds: Set<string>, options?: object | undefined): void;
    /**
     ...
     * @param {Set<Document>} documents The Document Set
     * @protected
     */
    protected _matchSearchDocuments(query: string, documents: Set<Document>): void;
    /**
     ...
     * @protected
     */
    protected _onMatchSearchDocuments(indexEntries: Set<WordTreeEntry["entry"]>, listEl: HTMLElement): void;
    /**
