...
export default class PlaylistDirectory extends DocumentDirectory<Playlist> {
    ...
    static override DEFAULT_OPTIONS: {
        ...
        actions: {
            pinCurrentlyPlaying: Function;
            playlistBackward: Function;
            playlistForward: Function;
            ...
            soundPause: Function;
            soundPlay: Function;
            soundRepeat: Function;
            soundStop: Function;
            volumeExpand: Function;
        };
    };
    /** @override */
     ...
     */
    static "__#350@#onPinCurrentlyPlaying"(this: PlaylistDirectory): void;
    /**
     ...
     */
    static "__#350@#onPlaylistCycleMode"(this: PlaylistDirectory, event: PointerEvent, target: HTMLElement): Promise<Playlist>;
    /**
     ...
     * @param {HTMLElement} target  The action target.
     */
    static "__#350@#onPlaylistPlayback"(this: PlaylistDirectory, event: PointerEvent, target: HTMLElement): Promise<Playlist>;
    /**
     ...
     * @param {HTMLElement} target  The action target.
     */
    static "__#350@#onPlaylistSkip"(this: PlaylistDirectory, event: PointerEvent, target: HTMLElement): Promise<Playlist | null | undefined>;
    /**
     ...
     * @param {HTMLElement} target  The action target.
     */
    static "__#350@#onSoundAdd"(this: PlaylistDirectory, event: PointerEvent, target: HTMLElement): void;
    /**
     ...
     * @param {HTMLElement} target  The action target.
     */
    static "__#350@#onSoundPlayback"(this: PlaylistDirectory, event: PointerEvent, target: HTMLElement): any;
    /**
     ...
     * @param {HTMLElement} target  The action target.
     */
    static "__#350@#onSoundToggleMode"(this: PlaylistDirectory, event: PointerEvent, target: HTMLElement): any;
    /**
     ...
     */
    static "__#350@#onVolumeExpand"(this: PlaylistDirectory, event: PointerEvent, target: HTMLElement): void;
    /**
...
import type Playlist from "../../../documents/playlist.mjs";
