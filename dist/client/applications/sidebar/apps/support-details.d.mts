declare const SupportDetails_base: {
    new (...args: any[]): {
 ...
 */
export default class SupportDetails extends SupportDetails_base {
    /** @inheritDoc */
    ...
    static "__#340@#onCopyReport"(event: PointerEvent, target: HTMLElement): void | Promise<void>;
    /**
     * Handle click events to copy the UUID of this document to clipboard.
     * @param {PointerEvent} event
     * @this {SupportDetails}
     */
    static "__#340@#onCopyUuid"(this: SupportDetails, event: PointerEvent): void;
    /**
     * Handle click events to delete a document.
     * @param {PointerEvent} event
     * @this {SupportDetails}
     */
    static "__#340@#onDeleteDocument"(this: SupportDetails, event: PointerEvent): Promise<void>;
    static "__#340@#onGenerateFullReport"(event: PointerEvent, target: HTMLElement): void | Promise<void>;
    /**
     ...
     */
    static "__#340@#getLargestTexture"(): {
        width: number;
        height: number;
        [src]: string;
    };
    ...
    /** @inheritDoc */
    _preparePartContext(partId: any, context: any, options: any): Promise<ApplicationRenderContext>;
    /**
