...
export default class ModuleManagement extends ApplicationV2<foundry.applications.types.ApplicationConfiguration, foundry.applications.types.ApplicationRenderOptions> {
     ...
     */
    static "__#339@#onDeactivateAll"(this: ModuleManagement, event: PointerEvent): void;
    /**
     ...
     */
    static "__#339@#onChangeFilter"(this: ModuleManagement, _event: PointerEvent, target: HTMLButtonElement): void;
    /**
     * Handle a button-click to deactivate all modules.
     * @this {ModuleManagement}
     */
    static "__#339@#onToggleExpanded"(this: ModuleManagement): void;
    static "__#339@#onSubmitForm"(event: SubmitEvent | Event, form: HTMLFormElement, formData: foundry.applications.ux.FormDataExtended): Promise<any>;
    /**
     ...
     * @internal
     */
    _formatDocumentSummary(counts: ModuleSubTypeCounts, verbose: boolean, module?: any): string;
    /** @inheritDoc */
