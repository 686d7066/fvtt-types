declare const WorldConfig_base: {
    new (...args: any[]): {
        ...
        attachWindow(options?: import("../../api/handlebars-application.mjs").HandlebarsRenderOptions | undefined): Promise<ApplicationV2<ApplicationConfiguration, foundry.applications.types.ApplicationRenderOptions>>;
 ...
 */
export default class WorldConfig extends WorldConfig_base {
    /** @inheritDoc */
     ...
     * @type {string}
     */
    static "__#341@#WORLD_KB_URL": string;
    static "__#341@#onSubmit"(event: SubmitEvent | Event, form: HTMLFormElement, formData: foundry.applications.ux.FormDataExtended): Promise<any>;
    /**
     * @param {Partial<ApplicationConfiguration> & WorldConfigOptions} options Application configuration options
     */
    constructor(options: Partial<ApplicationConfiguration> & WorldConfigOptions);
    /**
    ...
    /** @override */
    override _prepareContext(options?: {}): Promise<{
        source: foundry.packages.types.WorldManifestData;
        fields: foundry.abstract.types.DataSchema;
        rootId: string;
        themes: {};
        worldId: string;
        worldTitle: string;
...
export type WorldConfigOptions = {
    /**
...
import type World from "../../../packages/world.mjs";
export {};
