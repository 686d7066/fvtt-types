declare const InvitationLinks_base: {
    new (...args: any[]): {
 ...
 */
export default class InvitationLinks extends InvitationLinks_base {
    /** @inheritDoc */
    ...
    static "__#331@#onCopyLink"(event: PointerEvent, target: HTMLElement): void | Promise<void>;
    static "__#331@#onRecheckInternet"(event: PointerEvent, target: HTMLElement): void | Promise<void>;
    static "__#331@#onShowLink"(event: PointerEvent, target: HTMLElement): void | Promise<void>;
    static "__#331@#onHideLink"(event: PointerEvent, target: HTMLElement): void | Promise<void>;
    /** @override */
    override _prepareContext(): Promise<any>;
}
