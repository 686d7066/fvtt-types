 ...
 * @property {ApplicationRenderOptions} [renderOptions]  Options forwarded to the dialog's render call.
 */
/**
 ...
 * ```
 */
export default class DialogV2 extends ApplicationV2<ApplicationConfiguration & DialogV2Configuration, ApplicationRenderOptions> {
    /** @inheritDoc */
     ...
     */
    static confirm({ yes, no, ...config }?: Partial<ApplicationConfiguration & DialogV2Configuration & DialogV2WaitOptions> | undefined): Promise<any>;
    /**
     ...
     *                                                resolves to null.
     */
    static prompt({ ok, ...config }?: Partial<ApplicationConfiguration & DialogV2Configuration & DialogV2WaitOptions> | undefined): Promise<any>;
    /**
     ...
     *                                                resolves to null.
     */
    static input({ ok, ...config }?: Partial<ApplicationConfiguration & DialogV2Configuration & DialogV2WaitOptions> | undefined): Promise<any>;
    /**
     ...
     *                                                  resolves to null.
     */
    static wait({ rejectClose, close, render, renderOptions, ...config }?: Partial<ApplicationConfiguration & DialogV2Configuration & DialogV2WaitOptions> | undefined): Promise<any>;
    /**
     ...
     */
    static query(user: User | string, type: "prompt" | "confirm" | "input" | "wait", config?: object | undefined): Promise<any | null>;
    /**
...
export type DialogV2WaitOptions = {
     ...
     */
    renderOptions?: ApplicationRenderOptions | undefined;
};
