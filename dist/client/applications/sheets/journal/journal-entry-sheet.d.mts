 ...
 * @import {JournalEntryPageHeading} from "../../../_types.mjs";
 */
/**
 * @typedef _JournalSheetRenderOptions
 * {@ignore}
 ...
 */
/**
 * @typedef {DocumentSheetRenderOptions & _JournalSheetRenderOptions} JournalSheetRenderOptions
 * {@interface}
 */
/**
...
export default class JournalEntrySheet {
     ...
     * @type {number}
     */
    static "__#304@#INTERSECTION_RATIO": number;
    /**
     ...
     */
    static "__#304@#onConfigureCategories"(this: JournalEntrySheet): void;
    /**
     ...
     */
    static "__#304@#onGoToHeading"(this: JournalEntrySheet, event: PointerEvent, target: HTMLElement): void;
    /**
     * Handle toggling the lock mode.
     * @this {JournalEntrySheet}
     */
    static "__#304@#onToggleLock"(this: JournalEntrySheet): void;
    /**
     * Handle toggling the view mode.
     * @this {JournalEntrySheet}
     */
    static "__#304@#onToggleMode"(this: JournalEntrySheet): any;
    /**
     ...
     * @protected
     */
    protected _setCurrentPage(options?: JournalSheetRenderOptions | undefined): void;
    /**
 ...
 * {@ignore}
 */
export type _JournalSheetRenderOptions = {
    /**
 ...
 * {@interface}
 */
export type JournalSheetRenderOptions = DocumentSheetRenderOptions & _JournalSheetRenderOptions;
...
import type { JournalEntryPageHeading } from "../../../_types.mjs";
