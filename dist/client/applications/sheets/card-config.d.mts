...
export default class CardConfig extends DocumentSheetV2 {
    ...
    static "__#313@#TYPES": any;
    static "__#313@#onAddFace"(event: PointerEvent, target: HTMLElement): void | Promise<void>;
    static "__#313@#onDeleteFace"(event: PointerEvent, target: HTMLElement): void | Promise<void>;
    /** @inheritDoc */
