...
export default class ActorSheetV2 extends DocumentSheetV2 {
    ...
    static DEFAULT_OPTIONS: {
        ...
        actions: {
            configurePrototypeToken: Function;
            configureToken: Function;
            showPortraitArtwork: Function;
            showTokenArtwork: Function;
        };
    };
    /**
     ...
     */
    static "__#311@#onConfigurePrototypeToken"(this: ActorSheetV2, event: PointerEvent): void;
    /**
     * Handle rendering the token's configuration sheet.
     * @this {ActorSheetV2}
     */
    static "__#311@#onConfigureToken"(this: ActorSheetV2): void;
    /**
     * Handle header control button clicks to display actor portrait artwork.
     * @this {ActorSheetV2}
     * @param {PointerEvent} event
     */
    static "__#311@#onShowPortraitArtwork"(this: ActorSheetV2, event: PointerEvent): void;
    /**
     * Handle header control button clicks to display actor portrait artwork.
     * @this {ActorSheetV2}
     * @param {PointerEvent} event
     */
    static "__#311@#onShowTokenArtwork"(this: ActorSheetV2, event: PointerEvent): void;
    /**
