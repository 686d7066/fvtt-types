declare const MeasuredTemplateConfig_base: {
    new (...args: any[]): {
        ...
        "__#231@#children": Map<string, foundry.applications.api.ApplicationV2>;
        "__#231@#parent": foundry.applications.api.ApplicationV2 | null;
        "__#231@#priorParent": WeakRef<foundry.applications.api.ApplicationV2> | null;
        readonly window: {
            windowId: string;
            header: HTMLElement;
            resize: HTMLElement;
        ...
        readonly children: Map<string, foundry.applications.api.ApplicationV2<ApplicationConfiguration, foundry.applications.types.ApplicationRenderOptions>>;
        readonly parent: foundry.applications.api.ApplicationV2<ApplicationConfiguration, foundry.applications.types.ApplicationRenderOptions> | null;
        ...
        attachWindow(options?: import("../api/handlebars-application.mjs").HandlebarsRenderOptions | undefined): Promise<foundry.applications.api.ApplicationV2<ApplicationConfiguration, foundry.applications.types.ApplicationRenderOptions>>;
    ...
    BASE_APPLICATION: typeof foundry.applications.api.ApplicationV2;
    ...
    inheritanceChain(): Generator<typeof foundry.applications.api.ApplicationV2, void, unknown>;
 ...
 * @ignore
 */
export default class MeasuredTemplateConfig extends MeasuredTemplateConfig_base {
    /** @inheritDoc */
