...
export default class AdventureExporter extends DocumentSheetV2 {
    ...
    static "__#326@#onClearSection"(event: PointerEvent, target: HTMLElement): void | Promise<void>;
    static "__#326@#onCollapseSection"(event: PointerEvent, target: HTMLElement): void | Promise<void>;
    static "__#326@#onRemoveContent"(event: PointerEvent, target: HTMLElement): void | Promise<void>;
    constructor(options?: {});
    /**
