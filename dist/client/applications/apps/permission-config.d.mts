...
export default class PermissionConfig extends ApplicationV2<foundry.applications.types.ApplicationConfiguration, foundry.applications.types.ApplicationRenderOptions> {
     ...
     */
    static "__#287@#onSubmit"(this: DocumentSheetV2, event: SubmitEvent, form: HTMLFormElement, formData: FormDataExtended): Promise<void>;
    /**
     ...
     * @returns {Promise<void>}
     */
    static "__#287@#onReset"(this: PermissionConfig, event: PointerEvent): Promise<void>;
