...
export default class DocumentSheetConfig extends DocumentSheetConfig_base {
     ...
     */
    static "__#91@#onSubmitForm"(this: DocumentSheetConfig, event: SubmitEvent, form: HTMLFormElement, formData: FormDataExtended): Promise<void>;
    /**
     ...
     */
    static getSheetClassesForSubType(documentName: string, subType?: string | undefined): {
     ...
     */
    static "__#91@#pending": Array<SheetRegistrationDescriptor & {
     ...
     */
    static "__#91@#getDocumentTypes"(cls: typeof ClientDocument, types?: string[]): string[];
    /**
     ...
     */
    static "__#91@#registerSheet"(config?: SheetRegistrationDescriptor): void;
    /**
     ...
     */
    static "__#91@#unregisterSheet"(config?: Partial<SheetRegistrationDescriptor>): void;
    /**
