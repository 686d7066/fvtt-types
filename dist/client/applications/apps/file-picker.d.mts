 ...
 * @property {"any"|"audio"|"folder"|"font"|"graphics"|"image"|"imagevideo"|"text"|"texture"|"video"} [type="any"]
 ...
 * @property {ClientDocument} [document]   A Document instance associated with this FilePicker.
 */
/**
...
export default class FilePicker extends ApplicationV2<ApplicationConfiguration, foundry.applications.types.ApplicationRenderOptions> {
     ...
     * @returns {string[]}
     */
    static "__#14@#getExtensions"(type: string): string[];
    /**
     ...
     */
    static "__#14@#manageFiles"(data: object, options: object): Promise<object>;
    /**
     ...
     */
    static upload(source: string, path: string, file: File, body?: object | undefined, options?: {
     ...
     * @returns {Promise<object>}               The response object
     */
    static uploadPersistent(packageId: string, path: string, file: File, body?: object | undefined, { notify }?: {
        notify?: boolean | undefined;
    } | undefined): Promise<object>;
    /**
    ...
    static "__#14@#onChangeDisplayMode"(event: PointerEvent, target: HTMLElement): void | Promise<void>;
    static "__#14@#onBackTraverse"(event: PointerEvent, target: HTMLElement): void | Promise<void>;
    static "__#14@#onMakeDirectory"(event: PointerEvent, target: HTMLElement): void | Promise<void>;
    static "__#14@#onTogglePrivacy"(event: PointerEvent, target: HTMLElement): void | Promise<void>;
    static "__#14@#onGoToFavorite"(event: PointerEvent, target: HTMLElement): void | Promise<void>;
    static "__#14@#onSetFavorite"(event: PointerEvent, target: HTMLElement): void | Promise<void>;
    static "__#14@#onRemoveFavorite"(event: PointerEvent, target: HTMLElement): void | Promise<void>;
    static "__#14@#onPickDirectory"(event: PointerEvent, target: HTMLElement): void | Promise<void>;
    static "__#14@#onPickFile"(event: PointerEvent, target: HTMLElement): void | Promise<void>;
    static "__#14@#onSubmit"(event: SubmitEvent | Event, form: HTMLFormElement, formData: foundry.applications.ux.FormDataExtended): Promise<any>;
    /**
     ...
     */
    browse(target?: string | undefined, options?: object | undefined): Promise<this>;
    result: any;
    /** @inheritDoc */
...
export type FilePickerConfiguration = {
     ...
     * A type of file to target
     */
    type?: "any" | "imagevideo" | "folder" | "audio" | "font" | "graphics" | "image" | "text" | "texture" | "video" | undefined;
    /**
