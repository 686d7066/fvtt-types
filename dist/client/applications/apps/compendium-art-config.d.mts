...
export default class CompendiumArtConfig extends ApplicationV2<foundry.applications.types.ApplicationConfiguration, foundry.applications.types.ApplicationRenderOptions> {
     ...
     */
    static "__#283@#onAdjustPriority"(this: ApplicationV2<foundry.applications.types.ApplicationConfiguration, foundry.applications.types.ApplicationRenderOptions>, _event: MouseEvent, target: HTMLButtonElement): Promise<void>;
    /**
     ...
     */
    static "__#283@#onSubmit"(this: ApplicationV2<foundry.applications.types.ApplicationConfiguration, foundry.applications.types.ApplicationRenderOptions>, _event: SubmitEvent, _form: HTMLFormElement, formData: FormDataExtended): Promise<void>;
