...
export default class CameraViews extends ApplicationV2<ApplicationConfiguration, HandlebarsRenderOptions> {
     ...
     */
    static "__#281@#onToggleDocked"(this: CameraViews, event: PointerEvent, target: HTMLElement): Promise<void>;
    /**
     ...
     * @param {HTMLElement} target  The action target.
     */
    static "__#281@#onToggleDock"(this: CameraViews, event: PointerEvent, target: HTMLElement): Promise<CameraViews>;
    /**
